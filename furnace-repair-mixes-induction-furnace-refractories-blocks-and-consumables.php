    ...
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/induction_furnace/FurnaceRepairMixes.webp"
          alt="Repair Mixes - Induction Furnace Refractories Blocks and Consumables - Refractotherm" />
      ...
      <div class="split__body reveal">
        ...
        <p>These repair mixes exhibit excellent adhesion to existing refractory surfaces, whether hot or cold. They are
          easy to apply and rapidly develop high strength, making them ideal for localized repairs of slag lines,
          spouts, and furnace bottoms, thereby optimizing operational efficiency.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Excellent bonding with both hot and cold refractory surfaces
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Fast setting and rapid strength development
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ideal for quick turnaround repairs
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Extends the overall life of the furnace lining
          </li>
        </ul>
      </div>
    </div>
