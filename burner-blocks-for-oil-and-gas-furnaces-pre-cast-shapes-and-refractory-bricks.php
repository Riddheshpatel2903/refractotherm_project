  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>PRE-CAST SHAPES &amp; REFRACTORY
        BRICKS</span>
      <h2 class="page-banner-title">Burner Blocks for Oil & Gas Furnaces</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/precast_shape/burnerblocksforoil&gasfurnaces.webp"
          alt="Burner Blocks for Oil & Gas Furnaces - Pre-Cast Shapes and Bricks" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Burner Blocks for Oil & Gas Furnaces</h3>
        <p class="lead">Burner Blocks (or burner quarls) are specialized pre-cast shapes designed to house the burner
          assembly in oil and gas-fired furnaces. They play a vital role in flame stabilization and combustion
          efficiency.</p>
        <p>Manufactured from high-purity alumina or mullite, our burner blocks are engineered to withstand intense
          radiant heat, direct flame wash, and aggressive alkaline vapors. They maintain precise internal geometries
          over long campaigns, ensuring that the flame profile remains focused and efficient, while protecting the
          metallic burner components from the harsh furnace environment.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Maintains precise internal geometry for optimal combustion efficiency
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Protects metallic burner nozzles from direct radiant heat and slag
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Highly resistant to thermal shock and rapid temperature changes
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Customizable to accommodate various burner designs and fuel types
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Burner Blocks for Oil & Gas Furnaces </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Burner Blocks for Oil & Gas Furnaces Quote</h3>
        <div class="row">
