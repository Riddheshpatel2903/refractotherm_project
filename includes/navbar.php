...
<!-- 
      ...
      <a href="industries" class="nav__link <?php echo ($activePage == 'industries') ? 'active' : ''; ?>">Industries</a>
      <a href="services" class="nav__link <?php echo ($activePage == 'services' || $activePage == 'service-details') ? 'active' : ''; ?>">Services</a>
      <a href="careers" class="nav__link <?php echo ($activePage == 'careers') ? 'active' : ''; ?>">Careers</a>
