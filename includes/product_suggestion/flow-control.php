  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      const allCategoryProducts = [
        ...
        { name: "Slide Gate Sand", link: "slide-gate-sand-flow-control-and-ladle-slide-gate-systems.html", image: "assets/images/resources/FlowControlSystems.jfif" },
        ...
        { name: "Bottom Purging (BP) Sets", link: "bottom-purging-bp-sets-flow-control-and-ladle-slide-gate-systems.html", image: "assets/images/resources/products/flowcontrol/BottomPurging(BP)Sets.webp" },
