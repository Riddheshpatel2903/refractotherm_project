...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Copper & Non-Ferrous Furnace Refractories</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Copper & Non-Ferrous Furnace Refractories Details</li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      ...
      <div class="split__body reveal">
        ...
        <h3>Copper & Non-Ferrous Furnace Refractories</h3>
        <p class="lead">Copper & Non-Ferrous Furnace Refractories are engineered for the smelting and refining of
          copper, lead, zinc, and other non-ferrous metals.</p>
        <p>These processes generate highly fluid, penetrating slags that rapidly dissolve standard refractories. We
          supply ultra-low porosity, direct-bonded Magnesia-Chrome bricks for the slag lines and high-purity
          Alumina-Chrome castables for complex shapes. These linings provide exceptional chemical resistance and
          structural integrity, enduring the intense thermal and chemical demands of non-ferrous metallurgy.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ultra-low porosity prevents penetration of highly fluid, aggressive slags
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Direct-bonded Magnesia-Chrome provides exceptional chemical resistance
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High structural integrity withstands intense thermal cycling and stirring
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Tailored solutions for copper converters, anode furnaces, and lead refiners
          </li>
        </ul>
      </div>
    </div>
