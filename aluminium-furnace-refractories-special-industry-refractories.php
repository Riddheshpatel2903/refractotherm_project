...
<?php
$title = 'Aluminium Furnace Refractories Manufacturer & Supplier | Refractotherm';
...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Aluminium Furnace Refractories</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li><a href="products#special-industry-refractories">SPECIAL INDUSTRY REFRACTORIES</a></li>
      <li class="active">Aluminium Furnace Refractories Details</li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/spacial_industries/AluminiumFurnaceRefractories.webp"
          alt="Aluminium Furnace Refractories - Refractotherm" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Aluminium Furnace Refractories</h3>
        <p class="lead">Aluminium Furnace Refractories must overcome the aggressive nature of molten aluminium, which
          deeply penetrates traditional refractories and forms destructive corundum growths.</p>
        <p>Our specialized castables and bricks for aluminium melting and holding furnaces incorporate specific
          non-wetting agents (such as Barium Sulfate). These additives dramatically increase the contact angle of the
          molten metal, effectively preventing penetration. This eliminates corundum build-up on the walls, maintaining
          the furnace capacity and significantly easing cleaning and maintenance.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Advanced non-wetting agents absolutely prevent aluminium penetration
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Eliminates destructive corundum growth on furnace walls and hearths
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Maintains furnace capacity and drastically reduces cleaning time
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High abrasion resistance against mechanical charging and fluxing
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Aluminium Furnace Refractories </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Aluminium Furnace Refractories Quote</h3>
        <div class="row">
