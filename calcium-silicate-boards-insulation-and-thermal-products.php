...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Calcium Silicate Boards</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Calcium Silicate Boards Details</li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/insulation/CalciumSilicateBoards.webp"
          alt="Calcium Silicate Boards - Thermal Insulation" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Calcium Silicate Boards</h3>
        <p class="lead">Calcium Silicate Boards are rigid, highly efficient, asbestos-free insulation products
          characterized by their low bulk density and exceptionally low thermal conductivity.</p>
        <p>These boards are structurally robust and are typically installed as the ultimate backup layer against the
          steel casing of furnaces, kilns, and ladles. By dramatically reducing heat transfer to the exterior shell,
          they minimize overall energy consumption, improve process temperature control, and ensure a safer working
          environment for plant personnel.</p>
        <ul class="check overview-check-list">
          ...
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Lightweight yet structurally robust to support dense working linings
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Dramatically reduces cold-face (steel shell) temperatures
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Completely asbestos-free and safe for industrial environments
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Calcium Silicate Boards </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Calcium Silicate Boards Quote</h3>
        <div class="row">
