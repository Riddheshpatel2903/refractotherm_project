...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Mud Gun Mass</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Mud Gun Mass </li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/blast_furnace/MudGunMass.webp"
          alt="Mud Gun Mass for Blast Furnace and DRI Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Mud Gun Mass</h3>
        <p class="lead">Mud Gun Mass (synonymous with Tap Hole Clay) is the critical consumable for casthouse
          operations, injected via the high-pressure mud gun to safely terminate the casting process.</p>
        <p>Engineered with a carefully selected matrix of alumina, silicon carbide, coke, and special binders, our Mud
          Gun Mass exhibits optimized extrusion characteristics. It effectively pushes back molten slag and iron,
          filling internal voids and helping to maintain the critical 'mushroom' inside the hearth, which protects the
          furnace lining.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Optimized extrusion properties for smooth injection via the mud gun
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Helps maintain the protective internal 'mushroom' in the hearth
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Resists erosion from the high-velocity flow of iron and slag
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Consistent plasticity regardless of ambient temperature variations
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Mud Gun Mass </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Mud Gun Mass Quote</h3>
        <div class="row">
