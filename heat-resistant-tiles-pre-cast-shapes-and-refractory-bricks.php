  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>PRE-CAST SHAPES &amp; REFRACTORY
        BRICKS</span>
      <h2 class="page-banner-title">Heat Resistant Tiles</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/precast_shape/HeatResistantTiles.jpg"
      ...
      <div class="split__body reveal">
        ...
        <p>Manufactured for high density and mechanical strength, these tiles offer excellent resistance to foot
          traffic, forklift abrasion, and continuous thermal exposure. They provide a safe, durable surface in hot
          zones, ensuring long-term protection against radiant heat and physical wear.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Provides a durable, safe paving solution for high-temperature zones
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High mechanical strength resists abrasion from foot and vehicle traffic
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Excellent resistance to radiant heat and continuous thermal exposure
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ideal for industrial floors, transport chutes, and flue linings
          </li>
        </ul>
      </div>
    </div>
