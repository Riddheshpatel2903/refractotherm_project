  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>PRE-CAST SHAPES &amp; REFRACTORY
        BRICKS</span>
      <h2 class="page-banner-title">Acid Resistant Bricks</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/precast_shape/AcidResistantBricks.jfif"
      ...
      <div class="split__body reveal">
        ...
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            ...
            Exceptional resistance to highly corrosive acids (except HF)
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Extremely low porosity and water absorption prevents chemical penetration
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High compressive strength and resistance to mechanical abrasion
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ideal for chemical plants, fertilizer units, and pickling lines
          </li>
        </ul>
      </div>
    </div>
