...
<?php
$title = 'Ceramic Pouring Cups Manufacturer & Supplier | Refractotherm';
$description = 'Ceramic Pouring Cups (or pouring basins) are critical components at the very start of the gating system in both sand casting and investment casting foun...';
$keywords = 'Ceramic Pouring Cups, Foundry And Metallurgical Consumables, Refractory Usage, Industrial Refractories, High Temperature Refractories, Refractotherm';
...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>FOUNDRY &amp; METALLURGICAL
        CONSUMABLES</span>
      <h1 class="page-banner-title">Ceramic Pouring Cups</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li><a href="products#foundry-and-metallurgical-consumables">FOUNDRY &amp; METALLURGICAL CONSUMABLES</a></li>
      <li class="active">Ceramic Pouring Cups Details</li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/foundries/CeramicPouringCups.webp"
          alt="Ceramic Pouring Cups - Foundry &amp; Metallurgical Consumables" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Ceramic Pouring Cups</h3>
        <p class="lead">Ceramic Pouring Cups (or pouring basins) are critical components at the very start of the gating
          system in both sand casting and investment casting foundries.</p>
        <p>Manufactured from high-purity alumina or zircon, our pouring cups are designed to receive the initial impact
          of the molten metal stream from the ladle. They effectively absorb kinetic energy, reducing turbulence and
          splashing, while providing a dense, non-wetting surface that prevents the entrainment of air and sand
          inclusions into the casting.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Absorbs initial pour impact to significantly reduce metal turbulence
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Non-wetting surface prevents metal penetration and sand wash
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ensures clean, smooth metal flow into the sprue and gating system
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Available in various standardized shapes and custom profiles
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Ceramic Pouring Cups </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Ceramic Pouring Cups Quote</h3>
        <div class="row">
