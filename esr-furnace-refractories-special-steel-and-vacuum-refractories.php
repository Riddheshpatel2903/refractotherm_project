...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>SPECIAL STEEL &amp; VACUUM
        REFRACTORIES</span>
      <h1 class="page-banner-title">ESR Furnace Refractories</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">ESR Furnace Refractories Details</li>
    </ol>
  </nav>
    ...
    <div class="container split">
      ...
      <div class="split__body reveal">
        ...
        <p>In the ESR process, the refractory must not introduce any inclusions into the highly reactive, superheated
          slag pool. We manufacture ultra-pure, high-alumina and magnesia-based castables and ramming masses for the
          base plate and crucible lining. These materials exhibit near-zero porosity and absolute chemical inertness to
          ensure the immaculate quality of the remelted ingot.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ultra-high purity formulations guarantee zero inclusion transfer
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Absolute chemical inertness against highly reactive, superheated slags
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Near-zero porosity prevents slag penetration and wear
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Essential for the production of aerospace-grade superalloys
          </li>
        </ul>
      </div>
    </div>
