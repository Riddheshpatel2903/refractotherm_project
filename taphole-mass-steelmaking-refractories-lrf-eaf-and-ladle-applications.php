...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h2 class="page-banner-title">Taphole Mass</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      ...
      <div class="split__body reveal">
        ...
        <h3>Taphole Mass</h3>
        <p class="lead">Taphole Mass is a specialized, unshaped refractory material used to pack the annular space
          around taphole sleeves or to fill the taphole in Eccentric Bottom Tapping (EBT) furnaces. It ensures a secure
          seal and safe, reliable opening during tapping.</p>
        <p>Our Taphole Mass formulations are carefully designed to sinter properly at the hot face while remaining
          granular at the cold face, allowing for easy and predictable free-opening of the taphole. It resists sintering
          under static load but provides excellent resistance to erosion during the high-velocity discharge of molten
          steel.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ensures high free-opening rates for EBT and conventional tapholes
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Optimized sintering profile prevents hard crust formation
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Provides a secure seal against molten steel penetration
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High refractoriness and resistance to chemical corrosion
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Taphole Mass </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Taphole Mass Quote</h3>
        <div class="row">
