...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Burner Blocks</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Burner Blocks </li>
    </ol>
  </nav>
    ...
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/aod/burnerblocks.webp"
          alt="Burner Blocks for AOD and Secondary Metallurgy" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h2>Burner Blocks</h2>
        <p class="lead">Burner Blocks for AOD applications are utilized primarily in preheating stations and specialized
          converter heating systems. They securely house the burner nozzles, ensuring precise flame geometry for
          efficient, uniform heating of the AOD lining prior to charging.</p>
        <p>Fabricated from high-purity alumina and mullite castables, these pre-cast blocks are virtually immune to
          rapid thermal cycling and direct flame impingement. They protect the metallic burner components from radiant
          heat and stray slag, ensuring reliable preheating operations which are vital for extending the lifespan of the
          working lining.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ensures precise flame geometry for uniform AOD preheating
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Protects sensitive burner nozzles from radiant heat damage
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Outstanding resistance to rapid thermal cycling
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Pre-cast and pre-fired for immediate installation
          </li>
        </ul>
      </div>
    </div>
