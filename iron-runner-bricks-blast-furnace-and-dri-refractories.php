...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Iron Runner Bricks</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Iron Runner Bricks </li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/blast_furnace/IronRunnerBricks.webp"
          alt="Iron Runner Bricks for Blast Furnace and DRI Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Iron Runner Bricks</h3>
        <p class="lead">Iron Runner Bricks provide a pre-fired, highly reliable alternative to monolithic linings for
          specific runner designs, particularly where immediate installation and rapid heat-up are required.</p>
        <p>Manufactured from premium Alumina-Silicon Carbide-Carbon (ASC) compositions, these bricks are pressed under
          extremely high pressure and cured at optimal temperatures. They deliver precise dimensional tolerances, tight
          joints, and exceptional resistance to the erosive and corrosive effects of molten iron and slag.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Pre-fired for immediate installation and rapid operational turnaround
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High structural integrity and precise dimensional tolerances
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Superior resistance to thermal spalling and metal penetration
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ideal for specific secondary runner or launder configurations
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Iron Runner Bricks </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Iron Runner Bricks Quote</h3>
        <div class="row">
