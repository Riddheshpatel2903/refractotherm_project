  ...
  <section class="section">
    <div class="container split">
      ...
      <div class="split__body reveal">
        ...
        <h2>Safety Lining Materials</h2>
        <p class="lead">Safety Lining Materials (or permanent linings) form the crucial backup layer in an AOD vessel,
          situated directly against the steel shell. They act as the final barrier against catastrophic molten metal
          breakouts in the event of severe working lining wear.</p>
        <p>Typically composed of high-quality fired Magnesia or Chrome-Magnesia bricks, our safety linings offer
          excellent volume stability, high compressive strength, and resistance to metal penetration. They provide a
          rigid, stable foundation for the working lining, absorbing mechanical stresses and protecting the converter
          shell from distortion.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Acts as a reliable final barrier to prevent catastrophic metal breakouts
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High compressive strength provides a stable foundation for working linings
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Protects the steel converter shell from extreme thermal distortion
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Excellent volume stability ensures tight, secure joints
          </li>
        </ul>
      </div>
    </div>
