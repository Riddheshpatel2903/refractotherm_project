...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>FOUNDRY &amp; METALLURGICAL
        CONSUMABLES</span>
      <h1 class="page-banner-title">Foundry Coatings</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Foundry Coatings Details</li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/foundries/FoundryCoatings.webp"
          alt="Foundry Coatings - Foundry &amp; Metallurgical Consumables" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Foundry Coatings</h3>
        <p class="lead">Foundry Coatings (commonly referred to as mold washes or core washes) are refractory liquids or
          pastes applied to the surface of sand molds and cores.</p>
        <p>Available in Zircon, Magnesite, Alumina, and Graphite bases, our coatings create a dense, highly refractory
          barrier between the molten metal and the sand. This barrier prevents metal penetration, reduces sand burn-on,
          and significantly improves the surface finish of the final casting, thereby minimizing expensive shot-blasting
          and fettling operations.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Creates a dense barrier preventing metal penetration and sand burn-on
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Significantly improves the surface finish and dimensional accuracy
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Reduces post-casting cleaning, shot-blasting, and fettling times
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Available in water-based or alcohol-based formulations
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Foundry Coatings </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Foundry Coatings Quote</h3>
        <div class="row">
