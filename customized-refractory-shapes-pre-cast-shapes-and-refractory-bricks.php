...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>PRE-CAST SHAPES &amp; REFRACTORY
        BRICKS</span>
      <h1 class="page-banner-title">Customized Refractory Shapes</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Customized Refractory Shapes Details</li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/precast_shape/CustomizedRefractoryShapes.webp"
          alt="Customized Refractory Shapes - Pre-Cast Shapes and Bricks" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Customized Refractory Shapes</h3>
        <p class="lead">When standard brick formats are insufficient, our Customized Refractory Shapes provide the
          perfect engineered solution. We have the capability to design, mold, and fire highly complex geometries.</p>
        <p>Whether you require intricate burner blocks, unique flue transitions, or specific baffle plates, our
          engineering team works directly from your CAD drawings. Utilizing advanced pre-casting and pressing
          techniques, we deliver bespoke shapes that guarantee perfect fitment, minimizing installation time and mortar
          usage.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Engineered and manufactured directly from client CAD drawings
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Eliminates the need for on-site cutting and reduces installation time
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Guarantees perfect fitment and minimizes vulnerable mortar joints
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Available in any required refractory grade (Alumina, SiC, Basic)
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Customized Refractory Shapes </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Customized Refractory Shapes Quote</h3>
        <div class="row">
