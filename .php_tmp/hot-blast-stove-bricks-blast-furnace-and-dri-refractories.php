...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Hot Blast Stove Bricks</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Hot Blast Stove Bricks </li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/blast_furnace/HotBlastStoveBricks.webp"
          alt="Hot Blast Stove Bricks for Blast Furnace and DRI Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Hot Blast Stove Bricks</h3>
        <p class="lead">Hot Blast Stove Bricks are crucial for preheating the air blast before it enters the blast
          furnace. They comprise the combustion chamber walls, the dome, and the complex checkerwork that stores and
          releases heat.</p>
        <p>Our portfolio includes creep-resistant High Alumina bricks and ultra-pure Silica bricks for the
          high-temperature dome and upper checkers, ensuring structural stability under load. The geometrically
          optimized checker bricks maximize the heat transfer surface area, significantly improving the thermal
          efficiency and hot blast temperature of the stove.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Creep-resistant High Alumina and Silica bricks for the high-temperature zones
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Optimized checker geometries maximize heat exchange efficiency
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High thermal capacity and excellent spalling resistance
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ensures stable, high-temperature hot blast delivery to the furnace
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Hot Blast Stove Bricks </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Hot Blast Stove Bricks Quote</h3>
        <div class="row">
