...
<body>
  ...
  <section class="section section--dark page-banner-section">
    <div class="page-banner-bg" style="background-image: url('assets/images/resources/products/aod_tuyeres-banner.webp'); opacity: 0.25;"></div>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">AOD Tuyeres</li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/aod_tuyeres.webp" alt="AOD Tuyeres Gas Injection Nozzles" />
      </div>
