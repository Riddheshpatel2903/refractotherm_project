...
<body>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Magnesia Carbon Bricks Details</li>
    </ol>
  </nav>
    ...
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/aod/MagnesiaCarbonBricks.webp"
          alt="Magnesia Carbon Bricks for AOD and Secondary Metallurgy" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Magnesia Carbon Bricks</h3>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Magnesia Carbon Bricks </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Magnesia Carbon Bricks Quote</h3>
        <div class="row">
