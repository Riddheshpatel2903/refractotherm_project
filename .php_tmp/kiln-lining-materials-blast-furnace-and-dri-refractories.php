...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Kiln Lining Materials</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Kiln Lining Materials </li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/blast_furnace/kilnliningmaterials.webp"
          alt="Kiln Lining Materials for Blast Furnace and DRI Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Kiln Lining Materials</h3>
        <p class="lead">Kiln Lining Materials encompass the complete package of working and safety refractories required
          to line Direct Reduction kilns, calcination kilns, and related metallurgical vessels.</p>
        <p>Beyond premium bricks, we supply high-strength castables for the kiln nose rings and feed ends, alongside
          high-efficiency backup insulation boards. This holistic lining system ensures optimal thermal profiles,
          prevents heat loss, and protects the kiln shell from distortion, maximizing overall energy efficiency and
          output.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Complete lining solutions including working bricks, castables, and insulation
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High-strength nose ring castables resist severe thermal and mechanical stress
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Backup insulation protects the kiln shell and reduces energy consumption
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Tailored designs based on specific kiln operating parameters
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Kiln Lining Materials </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Kiln Lining Materials Quote</h3>
        <div class="row">
