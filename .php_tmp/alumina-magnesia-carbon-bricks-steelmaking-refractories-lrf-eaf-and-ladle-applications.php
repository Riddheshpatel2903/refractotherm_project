...
<body>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Alumina Magnesia Carbon Bricks Details</li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      ...
      <div class="split__body reveal">
        ...
        <p class="lead">Alumina Magnesia Carbon (AMC) Bricks are advanced composite refractories engineered for the
          demanding conditions of steel ladles, particularly in the metal line and bottom impact zones. They combine the
          beneficial properties of alumina, magnesia, and graphite.</p>
        <p>During operation, the magnesia and alumina react to form in-situ spinel, causing a slight, controlled
          expansion that tightly seals the brick joints, preventing slag penetration. The combination of materials
          ensures excellent wear resistance, thermal shock stability, and structural integrity during prolonged
          secondary metallurgical treatments.</p>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Alumina Magnesia Carbon Bricks </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Alumina Magnesia Carbon Bricks Quote</h3>
        <div class="row">
