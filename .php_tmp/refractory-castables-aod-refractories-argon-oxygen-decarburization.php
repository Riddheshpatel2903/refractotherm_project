...
<body>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Refractory Castables Details</li>
    </ol>
  </nav>
    ...
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/aod/RefractoryCastables.webp"
          alt="Refractory Castables for AOD and Secondary Metallurgy" />
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Refractory Castables </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Refractory Castables Quote</h3>
        <div class="row">
