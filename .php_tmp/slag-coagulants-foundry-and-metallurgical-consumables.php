  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>FOUNDRY &amp; METALLURGICAL
        CONSUMABLES</span>
      <h2 class="page-banner-title">Slag Coagulants</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/foundries/SlagCoagulants.webp"
          alt="Slag Coagulants - Foundry &amp; Metallurgical Consumables" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Slag Coagulants</h3>
        <p class="lead">Slag Coagulants (or deslagging agents) are specialized mineral blends applied to the surface of
          the molten metal prior to pouring.</p>
        <p>Upon contact with the high-temperature bath, these compounds rapidly expand and react with the fluid, sticky
          slag. They cause the slag to agglomerate and coagulate into a tough, cohesive crust that is easily and cleanly
          skimmed off the surface. This ensures a clean pouring stream and prevents slag inclusions in the casting.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Rapidly agglomerates fluid slag into a cohesive, easily removable crust
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Facilitates quick and clean skimming of the furnace or ladle
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Prevents the carryover of slag inclusions into the mold
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Non-toxic, low-smoke formulations for a safer working environment
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Slag Coagulants </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Slag Coagulants Quote</h3>
        <div class="row">
