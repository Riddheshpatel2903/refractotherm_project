...
<?php
$title = 'Ceramic Fiber Blanket Manufacturer & Supplier | Refractotherm';
...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Ceramic Fiber Blanket</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Ceramic Fiber Blanket </li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/insulation/CeramicFiberBlanket.webp"
          alt="Ceramic Fiber Blanket - Thermal Insulation" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Ceramic Fiber Blanket</h3>
        <p class="lead">Ceramic Fiber Blankets are lightweight, flexible insulating materials manufactured from spun
          ceramic fibers, offering exceptional thermal stability up to 1430°C.</p>
        <p>These highly versatile blankets are completely inorganic, meaning they produce no smoke or outgassing upon
          initial heating. They possess extremely low thermal conductivity, low heat storage, and unparalleled
          resistance to thermal shock. They are widely used as the primary hot-face lining in kilns and furnaces, or as
          high-efficiency backup insulation behind dense refractories.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Extremely low thermal conductivity and low heat storage capacity
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Outstanding thermal shock resistance prevents cracking and spalling
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Lightweight and flexible for easy installation around complex geometries
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Contains no organic binders; absolutely no smoke or outgassing
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Ceramic Fiber Blanket </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Ceramic Fiber Blanket Quote</h3>
        <div class="row">
