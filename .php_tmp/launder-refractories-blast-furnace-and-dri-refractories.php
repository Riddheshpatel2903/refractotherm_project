...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Launder Refractories</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Launder Refractories </li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/blast_furnace/launderrefractories.webp"
          alt="Launder Refractories for Blast Furnace and DRI Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Launder Refractories</h3>
        <p class="lead">Launder Refractories are used to line the channels (launders) that transport molten hot metal or
          slag from the furnace tapping area to holding vessels or casting machines.</p>
        <p>We provide both monolithic castable solutions and pre-cast, pre-fired launder blocks. Manufactured from
          high-purity Alumina and Silicon Carbide, they offer a non-wetting surface that ensures smooth flow, minimal
          heat loss, and exceptional resistance to the erosive action of the molten stream.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Non-wetting surface prevents metal penetration and skull buildup
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High erosion resistance against flowing molten iron and slag
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Excellent insulating properties minimize heat loss during transport
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Available as on-site castables or rapid-install pre-cast blocks
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Launder Refractories </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Launder Refractories Quote</h3>
        <div class="row">
