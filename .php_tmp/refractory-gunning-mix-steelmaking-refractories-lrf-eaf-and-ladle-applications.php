...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Refractory Gunning Mix</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Refractory Gunning Mix Details</li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      ...
      <div class="split__body reveal">
        ...
        <p>Formulated with specialized chemical binders and plasticizers, our magnesia and alumina-based gunning mixes
          exhibit excellent adhesion to hot refractory surfaces with minimal rebound loss. They quickly sinter to form a
          dense, protective patch that restores lining thickness, significantly extending the overall campaign life of
          the metallurgical vessel.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Excellent adhesion to hot surfaces with minimal rebound loss
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Rapid installation and quick setting minimizes furnace downtime
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High refractoriness restores the integrity of worn lining zones
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Available in magnesia and alumina grades for various applications
          </li>
        </ul>
      </div>
    </div>
