...
<body>
      ...
      <div class="industries-slider">
        ...
        <div class="industries-track">
          ...
          <div class="industry-card">
            <img loading="lazy" src="assets/images/resources/IntegratedSteelPlants.webp">
            <div class="industry-overlay"></div>
            <div class="industry-content"><h3>Integrated Steel Plants</h3></div>
          </div>

          <div class="industry-card">
            <img loading="lazy" src="assets/images/resources/SecondarySteelPlants.webp">
            <div class="industry-overlay"></div>
            <div class="industry-content"><h3>Secondary Steel Plants</h3></div>
          </div>

          <div class="industry-card">
            <img loading="lazy" src="assets/images/resources/StainlessSteelPlants.webp">
            <div class="industry-overlay"></div>
            <div class="industry-content"><h3>Stainless Steel Plants</h3></div>
          </div>

          <div class="industry-card">
            <img loading="lazy" src="assets/images/resources/AlloySteelPlants.webp">
            <div class="industry-overlay"></div>
          ...
          <div class="industry-card">
            <img loading="lazy" src="assets/images/resources/FerroAlloyPlants.webp">
            <div class="industry-overlay"></div>
          ...
          <div class="industry-card">
            <img loading="lazy" src="assets/images/resources/LadleRefiningFurnaces(LRF).webp">
            <div class="industry-overlay"></div>
            <div class="industry-content"><h3>Ladle Refining Furnaces (LRF)</h3></div>
          </div>

          <div class="industry-card">
            <img loading="lazy" src="assets/images/resources/Continuous%20Casting%20Machines%20(CCM).webp">
            <div class="industry-overlay"></div>
            <div class="industry-content"><h3>Continuous Casting Machines (CCM)</h3></div>
          </div>

          <div class="industry-card">
            <img loading="lazy" src="assets/images/resources/Billet&SlabCastingPlants.webp">
            <div class="industry-overlay"></div>
            <div class="industry-content"><h3>Billet & Slab Casting Plants</h3></div>
          </div>

          <div class="industry-card">
            <img loading="lazy" src="assets/images/resources/RollingMillRefractories.webp">
            <div class="industry-overlay"></div>
          ...
          <div class="industry-card">
            <img loading="lazy" src="assets/images/resources/ReheatingFurnaces.webp">
            <div class="industry-overlay"></div>
            <div class="industry-content"><h3>Reheating Furnaces</h3></div>
          </div>

          <div class="industry-card">
            <img loading="lazy" src="assets/images/resources/SpongeIron(DRI)Plants.webp">
            <div class="industry-overlay"></div>
            <div class="industry-content"><h3>Sponge Iron (DRI) Plants</h3></div>
          </div>

          <div class="industry-card">
            <img loading="lazy" src="assets/images/resources/manufacture.webp">
            <div class="industry-overlay"></div>
            <div class="industry-content"><h3>Lime Plants</h3></div>
          </div>

          <div class="industry-card">
            <img loading="lazy" src="assets/images/resources/PetrochemicalIndustries.webp">
            <div class="industry-overlay"></div>
            <div class="industry-content"><h3>Petrochemical Industries</h3></div>
          </div>

          <div class="industry-card">
            <img loading="lazy" src="assets/images/resources/products/spacial_industries/Copper&Non-FerrousFurnaceRefractories.webp">
            <div class="industry-overlay"></div>
            <div class="industry-content"><h3>Non-Ferrous Metal Industries</h3></div>
          </div>

          <div class="industry-card">
            <img loading="lazy" src="assets/images/resources/CementPlants.webp">
            <div class="industry-overlay"></div>
  ...
  <section class="cta" id="contact">
    <div class="cta__bg" style="
          background-image: url(assets/images/resources/about-2.webp);
        "></div>
