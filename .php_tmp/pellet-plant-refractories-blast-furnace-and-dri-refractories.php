...
<body>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Pellet Plant Refractories </li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/blast_furnace/PelletPlantRefractories.webp"
          alt="Pellet Plant Refractories for Blast Furnace and DRI Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Pellet Plant Refractories</h3>
        <p class="lead">Pellet Plant Refractories are utilized throughout the iron ore pelletizing process, including
          the traveling grate, rotary kiln, and annular cooler, where they face high temperatures and severe abrasion
          from iron ore pellets.</p>
        <p>Our solutions encompass robust high-alumina castables for grate side-plates and burner blocks, as well as
          highly abrasion-resistant bricks for the rotary kiln and transfer chutes. These refractories maintain their
          physical integrity under heavy loads and rapid thermal cycling, ensuring continuous, high-volume pellet
          production.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Outstanding abrasion resistance against hard iron ore pellets
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High thermal shock resistance for traveling grates and coolers
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Robust castables for burner blocks and complex transition geometries
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Minimizes downtime and maintenance in high-throughput pellet plants
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Pellet Plant Refractories </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Pellet Plant Refractories Quote</h3>
        <div class="row">
