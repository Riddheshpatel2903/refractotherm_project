  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>CONTINUOUS CASTING MACHINE (CCM)
        CONSUMABLES</span>
      <h1 class="page-banner-title">Graphite Stopper Rods</h1>
    </div>
  </section>
    ...
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/ccm/GraphiteStopperRods.webp"
          alt="Tundish Well Blocks for Continuous Casting Flow Control Systems and Nozzle Support Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Graphite Stopper Rods</h3>
        <p class="lead">Tundish Well Blocks are critical refractory components installed in the bottom section of a
          tundish to house and support nozzles, stopper systems, and other flow-control devices used during continuous
          casting. They form an integral part of the tundish flow-control arrangement, ensuring proper alignment,
          structural support, and safe transfer of molten steel from the tundish to the casting mould.
        </p>
        <p>Designed to withstand prolonged exposure to molten steel, thermal cycling, and mechanical stresses, Tundish
          Well Blocks are manufactured from high-grade refractory materials that offer excellent resistance to erosion,
          thermal shock, and steel penetration. Their precision-engineered construction helps maintain operational
          stability, improve flow-control performance, and extend the service life of associated casting components.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Provides secure seating for tundish nozzles and flow-control systems

          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Excellent resistance to thermal shock and molten steel attack
          ...
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Supports reliable and safe continuous casting operations
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <p>Speak with our refractory and continuous casting specialists to select the most suitable Tundish Well Block
          solution for your casting operation. We offer customized designs and refractory compositions to match specific
          tundish configurations, steel grades, and production requirements.</p>
        <ul class="cta__info">
