  ...
  <section class="section">
    <div class="container split">
      ...
      <div class="split__body reveal">
        ...
        <p class="lead">Magnesia Carbon Bricks are premium composite refractories manufactured from high-purity
          dead-burnt magnesia, fused magnesia, and flake graphite. They are the standard choice for the most severe wear
          areas in steelmaking vessels like Basic Oxygen Furnaces (BOF), Electric Arc Furnaces (EAF), and steel ladles.
        </p>
        <p>These bricks exhibit outstanding resistance to chemical corrosion by basic slags and molten steel. The
          graphite network provides excellent thermal conductivity and thermal shock resistance, while antioxidants are
          added to protect the carbon matrix, ensuring extended lining life and lower specific refractory consumption.
        </p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Superior resistance to basic slag corrosion and metal penetration
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Excellent thermal shock resistance due to high thermal conductivity
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High hot strength and volume stability at elevated temperatures
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Customizable carbon content and antioxidant additions for specific wear zones
          </li>
        </ul>
      </div>
    </div>
