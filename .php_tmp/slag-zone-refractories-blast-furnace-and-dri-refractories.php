...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Slag Zone Refractories</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Slag Zone Refractories </li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/blast_furnace/SlagZoneRefractories.webp"
          alt="Slag Zone Refractories for Blast Furnace and DRI Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Slag Zone Refractories</h3>
        <p class="lead">Slag Zone Refractories are deployed in areas where liquid slag aggregates and reacts
          aggressively with the furnace lining, such as the lower sidewalls of melting furnaces or the transition zones
          of certain kilns.</p>
        <p>Depending on the specific slag chemistry (acidic vs. basic), we provide highly dense Magnesia-Chrome,
          Magnesia-Spinel, or ultra-high Alumina refractories. These products are engineered with extremely low porosity
          to prevent slag infiltration, thereby combating structural spalling and chemical dissolution.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Engineered to resist specific acidic or basic slag chemistries
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Extremely low apparent porosity prevents deep liquid slag infiltration
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Combats structural spalling and extends the life of critical wear zones
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High hot strength maintains integrity under severe operating conditions
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Slag Zone Refractories </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Slag Zone Refractories Quote</h3>
        <div class="row">
