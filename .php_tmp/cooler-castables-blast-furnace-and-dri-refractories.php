...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Cooler Castables</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Cooler Castables </li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/blast_furnace/CoolerCastables.webp"
          alt="Cooler Castables for Blast Furnace and DRI Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Cooler Castables</h3>
        <p class="lead">Cooler Castables are utilized in the cooling zones of DRI plants and pelletizing operations,
          where hot material is rapidly quenched by ambient air. This subjects the refractory lining to intense,
          repetitive thermal shock.</p>
        <p>Formulated with premium mullite, andalusite, and silicon carbide, our Cooler Castables offer exceptional
          resistance to sudden temperature drops and the abrasive impact of the cascading charge. They prevent severe
          cracking and flaking, ensuring the reliable operation of the cooling equipment.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Phenomenal resistance to intense, repetitive thermal shock
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High abrasion resistance against cascading DRI or iron pellets
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Excellent volume stability prevents shrinkage cracking during cooling
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Available in low-cement or conventional formulations based on requirements
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Cooler Castables </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Cooler Castables Quote</h3>
        <div class="row">
