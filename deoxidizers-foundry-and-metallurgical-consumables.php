...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>FOUNDRY &amp; METALLURGICAL
        CONSUMABLES</span>
      <h1 class="page-banner-title">Deoxidizers</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Deoxidizers Details</li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/foundries/Deoxidizers.webp"
          alt="Deoxidizers - Foundry &amp; Metallurgical Consumables" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Deoxidizers</h3>
        <p class="lead">Deoxidizers are critical metallurgical additions used to eliminate dissolved oxygen from the
          molten metal bath prior to casting, preventing the formation of gas porosity and oxide inclusions.</p>
        <p>We supply a range of high-purity deoxidizing agents, including Aluminum (shots/notches), Ferro-Silicon, and
          metallurgical grade Silicon Carbide. When added to the ladle or furnace, they react aggressively with
          dissolved oxygen to form stable oxides which float to the slag layer, ensuring sound, porosity-free castings
          with improved mechanical properties.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Rapidly eliminates dissolved oxygen to prevent gas porosity
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Improves metal fluidity and overall casting soundness
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Forms stable oxides that easily separate into the slag layer
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Available in various grades and sizings for controlled addition
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Deoxidizers </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Deoxidizers Quote</h3>
        <div class="row">
