  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>CONTINUOUS CASTING MACHINE (CCM)
        CONSUMABLES</span>
      <h2 class="page-banner-title">Casting Powder / Mould Powder</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      ...
      <div class="split__body reveal">
        ...
        <h3>Casting Powder / Mould Powder</h3>
      ...
      <div class="careers-timeline">
        <div class="careers-timeline-item reveal">
          <div class="careers-timeline-body">
            ...
            <p class="careers-timeline-desc">
              Ensures stable mould lubrication and consistent billet surface quality.
            </p>
          </div>
        </div>
        ...
        <div class="careers-timeline-item reveal">
          <div class="careers-timeline-body">
            ...
            <p class="careers-timeline-desc">
              Supports controlled solidification and improved casting efficiency.
            </p>
          </div>
        </div>
        <div class="careers-timeline-item reveal">
          <div class="careers-timeline-body">
            ...
            <p class="careers-timeline-desc">
              Provides optimized heat transfer and lubrication in high-speed casting applications.
            </p>
          </div>
        </div>
        <div class="careers-timeline-item reveal">
          <div class="careers-timeline-body">
            ...
            <p class="careers-timeline-desc">
              Designed for demanding steel grades requiring superior surface quality and cleanliness.
            </p>
          </div>
        </div>
      </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Casting Powder</h3>
        <p>Consult our continuous casting specialists to select the most suitable Casting Powder formulation for your
          steel grades, casting speeds, mould dimensions, and production requirements. Customized mould flux solutions
          are available for billet, bloom, slab, and specialty steel casting applications.</p>
        <ul class="cta__info">
      ...
      <form class="cta__form"
        ...
        <h3>Request Casting Powder Quote</h3>
        <div class="row">
