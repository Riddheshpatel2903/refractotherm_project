  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>PRE-CAST SHAPES &amp; REFRACTORY
        BRICKS</span>
      <h2 class="page-banner-title">Ceramic Anchors (SS304 / SS310)</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/precast_shape/CeramicAnchors.png"
      ...
      <div class="split__body reveal">
        ...
        <h3>Ceramic Anchors (SS304 / SS310)</h3>
        <p class="lead">Refractory Anchors are vital hardware components used to secure monolithic castable or plastic
          refractory linings to the steel casing of the furnace, preventing the lining from buckling or collapsing.</p>
        <p>We provide both fired Ceramic Anchors for ultra-high temperature applications and high-grade Metallic Anchors
          (typically SS304 or SS310) for standard applications. They are designed to accommodate the differential
          thermal expansion between the refractory and the steel shell, ensuring long-term lining stability.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Securely holds monolithic linings, preventing buckling and collapse
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Available in high-temperature alloys (SS304/SS310) or fired ceramic
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Accommodates differential thermal expansion between lining and shell
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Custom designs available (V-shape, Y-shape, Corrugated) for varying depths
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Ceramic Anchors (SS304 / SS310) </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Ceramic Anchors (SS304 / SS310) Quote</h3>
        <div class="row">
