...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>SPECIAL STEEL &amp; VACUUM
        REFRACTORIES</span>
      <h1 class="page-banner-title">Vacuum Degassing Refractories</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Vacuum Degassing Refractories </li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/spacial_steel/VacuumDegassingRefractories.webp"
          alt="Vacuum Degassing Refractories - Refractotherm" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Vacuum Degassing Refractories</h3>
        <p class="lead">Vacuum Degassing Refractories encompass the complete lining solutions for RH (Ruhrstahl-Heraeus)
          and other advanced vacuum degassing vessels.</p>
        <p>The lower vessel and snorkels of an RH degasser face the most brutal conditions in modern steelmaking: rapid
          thermal cycling, intense vacuum, and high-velocity circulation of liquid steel. Our portfolio includes
          ultra-dense, direct-bonded Magnesia-Chrome bricks for the vessel walls and specialized, highly
          erosion-resistant castables for the snorkels, maximizing campaign life and steel purity.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Direct-bonded Magnesia-Chrome bricks for maximum vacuum stability
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Extreme erosion resistance for RH snorkels and lower vessels
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Withstands rapid thermal cycling during discontinuous operations
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Crucial for achieving ultra-low carbon, hydrogen, and nitrogen levels
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Vacuum Degassing Refractories </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Vacuum Degassing Refractories Quote</h3>
        <div class="row">
