...
<body>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Low Cement Castables (LCC) </li>
    </ol>
  </nav>
    ...
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/monolithic/lowcementcastables(lcc).webp"
          alt="Low Cement Castables (LCC) - Monolithic Refractories and Castables" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h2>High-performance low cement casting materials.</h2>
        <p class="lead">
