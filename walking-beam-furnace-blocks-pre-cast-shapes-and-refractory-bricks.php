...
<?php
$title = "Walking Beam Furnace Blocks Manufacturer & Supplier | Refractotherm";
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>PRE-CAST SHAPES &amp; REFRACTORY
        BRICKS</span>
      <h2 class="page-banner-title">Walking Beam Furnace Blocks</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/precast_shape/walkingbeamfurnaceblocks.png"
          alt="Walking Beam Furnace Blocks - Pre-Cast Shapes and Bricks" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Walking Beam Furnace Blocks</h3>
        <p class="lead">Walking Beam Furnace Blocks are critical structural components used in the hearth of modern
          steel reheating furnaces, where heavy steel slabs or billets are 'walked' through the heating zones.</p>
        <p>These blocks must sustain immense compressive loads at extreme temperatures while resisting severe thermal
          shock and the abrasive scale falling from the steel. Our high-alumina and mullite-based precast blocks deliver
          outstanding structural integrity, preventing hearth deformation and ensuring smooth, uninterrupted movement of
          the steel charge.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Exceptional compressive strength under high temperatures
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Outstanding resistance to thermal cycling and heavy mechanical loads
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Resistant to chemical attack from iron oxide scale
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ensures a stable hearth profile for smooth billet/slab transport
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Walking Beam Furnace Blocks </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Walking Beam Furnace Blocks Quote</h3>
        <div class="row">
