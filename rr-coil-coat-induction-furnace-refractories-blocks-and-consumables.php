...
<?php
$title = "Rr Coil Coat Manufacturer & Supplier | Refractotherm";
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>INDUCTION FURNACE REFRACTORIES, BLOCKS &
        CONSUMABLES</span>
      <h2 class="page-banner-title">RR Coil Coat</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="" alt="RR Coil Coat for High Temperature Industrial Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>RR Coil Coat</h3>
        <p class="lead">RR Coil Coat is an advanced, high-performance coating material tailored for induction furnace
          coils. It offers exceptional arc resistance and insulation capabilities, ensuring maximum protection for the
          expensive copper coils in demanding foundry environments.</p>
        <p>Specially developed to handle high voltage gradients, RR Coil Coat dries to a hard, flexible finish that
          withstands the dynamic forces within the furnace. It minimizes downtime by preventing coil failures and
          ensuring a smooth, robust surface for refractory lining installation.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Advanced arc resistance for high-voltage furnaces
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Forms a flexible yet hard protective layer
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Enhances the overall life of induction coils
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Resistant to heat and mechanical abrasion
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for RR Coil Coat </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request RR Coil Coat Quote</h3>
        <div class="row">
