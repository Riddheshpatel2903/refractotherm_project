...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h2 class="page-banner-title">Insulating Castables</h2>
    </div>
  </section>
...
Used as backup and insulating linings in reheating furnaces, heat treatment furnaces, forging furnaces, and thermal processing equipment.

Boilers and Power Plants

Applied in boilers, ducts, combustion chambers, and thermal units where heat conservation and energy efficiency are critical.

Cement and Lime Kilns

Suitable for backup insulation layers in kiln systems to reduce heat loss and improve thermal efficiency.

Petrochemical and Process Heaters

Widely used in refinery heaters, reformers, reactors, and petrochemical processing equipment operating at elevated temperatures.
 -->

      <div class="careers-timeline">
        <div class="careers-timeline-item reveal">
          <div class="careers-timeline-body">
            <h4 class="careers-timeline-title">Industrial Furnaces
            </h4>
            <p class="careers-timeline-desc">Used as backup and insulating linings in reheating furnaces, heat
              treatment furnaces, forging furnaces, and thermal processing equipment.
            </p>
          </div>
        </div>
        ...
        <div class="careers-timeline-item reveal">
          <div class="careers-timeline-body">
            <h4 class="careers-timeline-title">Boilers and Power Plants
            </h4>
            <p class="careers-timeline-desc">Applied in boilers, ducts, combustion chambers, and thermal units
              where heat conservation and energy efficiency are critical.
            </p>
          </div>
        </div>
        ...
        <div class="careers-timeline-item reveal">
          <div class="careers-timeline-body">
            <h4 class="careers-timeline-title">Cement and Lime Kilns</h4>
            <p class="careers-timeline-desc">Suitable for backup insulation layers in kiln systems to reduce heat loss
        ...
        <div class="careers-timeline-item reveal">
          <div class="careers-timeline-body">
            <h4 class="careers-timeline-title">Petrochemical and Process Heaters</h4>
            <p class="careers-timeline-desc">Widely used in refinery heaters, reformers, reactors, and petrochemical
              processing equipment operating at elevated temperatures.
            </p>
          </div>
        </div>
      </div>
