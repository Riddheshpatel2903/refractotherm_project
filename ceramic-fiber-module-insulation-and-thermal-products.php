...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Ceramic Fiber Module</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Ceramic Fiber Module Details</li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/insulation/CeramicFiberModule.webp"
          alt="Ceramic Fiber Module - Thermal Insulation" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Ceramic Fiber Module</h3>
        <p class="lead">Ceramic Fiber Modules consist of tightly folded or stacked ceramic fiber blankets,
          pre-compressed and banded to specific densities, complete with integrated metallic anchoring systems.</p>
        <p>These modules drastically reduce furnace installation time. Upon cutting the restraining bands after
          installation, the fibers expand, creating a tightly sealed, gap-free monolithic hot-face lining. This system
          provides maximum energy savings, rapid heat-up and cool-down cycles, and offers excellent resistance to
          mechanical abuse and high-velocity burner streams.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Pre-compressed design expands to form a tight, gap-free lining
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Integrated anchoring systems facilitate rapid, secure installation
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Maximizes energy savings through ultra-low thermal conductivity
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Allows for extremely rapid furnace heat-up and cool-down cycles
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Ceramic Fiber Module </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Ceramic Fiber Module Quote</h3>
        <div class="row">
