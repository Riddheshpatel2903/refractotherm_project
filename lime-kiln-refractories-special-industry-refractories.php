...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Lime Kiln Refractories</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Lime Kiln Refractories Details</li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/spacial_industries/LimeKilnRefractories.webp"
          alt="Lime Kiln Refractories - Refractotherm" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Lime Kiln Refractories</h3>
        <p class="lead">Lime Kiln Refractories face a unique challenge: intense chemical attack from highly basic
          calcium oxide (quicklime) combined with severe mechanical abrasion.</p>
        <p>To combat this, we supply high-grade Magnesia-Spinel and specialized High-Alumina bricks designed
          specifically for the burning zones of both rotary and vertical shaft lime kilns. These refractories feature
          extremely low porosity, preventing alkaline infiltration and subsequent structural spalling, ensuring a
          smooth, continuous flow of high-quality lime.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Outstanding chemical resistance against basic calcium oxide (quicklime)
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Extremely low porosity prevents alkaline infiltration and spalling
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High abrasion resistance for vertical shaft and rotary kiln applications
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Optimized thermal profiles maximize fuel efficiency during burning
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Lime Kiln Refractories </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Lime Kiln Refractories Quote</h3>
        <div class="row">
