...
<body>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Nano Bonded Castables </li>
    </ol>
  </nav>
    ...
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/monolithic/nanobondedcastables.webp"
          alt="Nano Bonded Castables - Monolithic Refractories and Castables - Refractotherm" />
        
      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h2>Next-generation nano-bonded refractory technology.</h2>
        <p class="lead">
