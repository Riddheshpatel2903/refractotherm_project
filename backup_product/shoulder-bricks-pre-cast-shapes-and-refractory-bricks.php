  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>PRE-CAST SHAPES &amp; REFRACTORY
        BRICKS</span>
      <h2 class="page-banner-title">Shoulder Bricks</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/precast_shape/ShoulderBricks.webp"
          alt="Shoulder Bricks - Pre-Cast Shapes and Bricks" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Shoulder Bricks</h3>
        <p class="lead">Shoulder Bricks feature a stepped or angled profile, designed to facilitate structural
          transitions within furnace masonry, such as supporting an arch springing line or changing wall thicknesses.
        </p>
        <p>These load-bearing shapes are manufactured to withstand high compressive forces. They provide a stable,
          interlocking platform that ensures the structural continuity of the furnace lining, preventing the slippage or
          collapse of upper masonry courses during thermal expansion.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Stepped profile facilitates secure transitions in furnace masonry
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High compressive strength for supporting arch springing lines
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Interlocking design prevents slippage during thermal expansion
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Customizable profiles to match specific engineering drawings
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Shoulder Bricks </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Shoulder Bricks Quote</h3>
        <div class="row">
