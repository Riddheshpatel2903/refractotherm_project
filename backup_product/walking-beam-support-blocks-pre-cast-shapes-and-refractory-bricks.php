  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>PRE-CAST SHAPES &amp; REFRACTORY
        BRICKS</span>
      <h2 class="page-banner-title">Walking Beam Support Blocks</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/precast_shape/WalkingBeamSupportBlocks.webp"
          alt="Walking Beam Support Blocks - Pre-Cast Shapes and Bricks" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Walking Beam Support Blocks</h3>
        <p class="lead">Walking Beam Support Blocks (often used in conjunction with skid pipe insulation) are designed
          to support and insulate the intricate water-cooled pipe network inside a reheating furnace.</p>
        <p>By utilizing high-grade, thermal-shock-resistant castables, these support blocks drastically reduce heat loss
          to the cooling water, thereby improving the overall energy efficiency of the furnace. Furthermore, they
          protect the metallic pipes from direct flame impingement and mechanical damage from the moving steel charge.
        </p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Significantly reduces heat loss to the water-cooled pipe system
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Improves overall furnace energy efficiency and thermal profile
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Protects metallic pipes from flame impingement and mechanical wear
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Highly resistant to thermal shock and continuous vibration
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Walking Beam Support Blocks </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Walking Beam Support Blocks Quote</h3>
        <div class="row">
