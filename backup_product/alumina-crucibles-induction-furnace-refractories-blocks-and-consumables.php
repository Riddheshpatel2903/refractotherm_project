  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>INDUCTION FURNACE REFRACTORIES, BLOCKS &
        CONSUMABLES</span>
      <h2 class="page-banner-title">Alumina Crucibles</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/induction_furnace/AluminaCrucibles.webp"
          alt="Alumina Crucibles for High Temperature Laboratory, Metallurgical and Industrial Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Alumina Crucibles</h3>
        <p class="lead">Alumina Crucibles are high-performance refractory vessels designed for melting, calcination, and
          high-temperature chemical processing applications. Manufactured using high-purity alumina, these crucibles
          offer excellent thermal stability, chemical inertness, and resistance to extreme operating conditions, making
          them ideal for laboratory and industrial use.</p>
        <p>In high-temperature environments, crucibles must withstand rapid heating and cooling cycles while resisting
          chemical attack from molten metals, slags, and reactive compounds. Alumina Crucibles are engineered to deliver
          superior strength, durability, and thermal shock resistance. Their high alumina content ensures minimal
          contamination of samples, stable performance, and long service life across a wide range of metallurgical and
        ...
        <ul class="check overview-check-list">
          ...
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High purity alumina for minimal contamination
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Superior chemical resistance to molten metals and slags
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Alumina Crucibles </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Alumina Crucibles Quote</h3>
        <div class="row">
