...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h2 class="page-banner-title">EAF Side Wall Bricks</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/steelmaking/EAFSideWallBricks.webp"
          alt="EAF Side Wall Bricks for Steelmaking and Ladle Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>EAF Side Wall Bricks</h3>
        <p class="lead">EAF Side Wall Bricks form the critical working lining of the Electric Arc Furnace barrel. This
          zone, particularly the 'hot spots' near the electrodes, is exposed to devastating ultra-high temperatures,
          intense arc radiation, and aggressive chemical erosion from highly oxidized basic slags.</p>
        <p>We supply premium-grade Magnesia Carbon bricks specifically tailored for EAF side walls, featuring optimized
          graphite levels and robust antioxidant systems. These bricks maintain high thermal conductivity to dissipate
          heat towards the water-cooled panels, while providing an impenetrable barrier against slag and metal
          penetration.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Outstanding resistance to intense arc radiation and hot spot wear
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Superior chemical resistance against highly oxidized basic slags
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High thermal conductivity to work synergistically with cooling panels
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Zoned lining designs available to balance wear rates across the furnace
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for EAF Side Wall Bricks </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request EAF Side Wall Bricks Quote</h3>
        <div class="row">
