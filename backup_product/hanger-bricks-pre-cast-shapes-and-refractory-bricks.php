  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>PRE-CAST SHAPES &amp; REFRACTORY
        BRICKS</span>
      <h2 class="page-banner-title">Hanger Bricks</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/precast_shape/HangerBricks.webp"
          alt="Hanger Bricks - Pre-Cast Shapes and Bricks" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Hanger Bricks</h3>
        <p class="lead">Hanger Bricks (or anchor bricks) are specially designed with built-in sockets or slots that
          allow them to be mechanically suspended from the metallic superstructure of a furnace.</p>
        <p>They are the critical components used to construct flat suspended roofs and complex angled walls where
          gravity alone cannot support the lining. Manufactured from high-strength alumina or fireclay, they safely
          transfer the weight of the refractory lining to the steel framework, enduring extreme tension and thermal
          stress.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Features precise sockets for secure mechanical attachment to steelwork
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Enables the construction of wide, flat suspended furnace roofs
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High tensile strength to safely bear the weight of the refractory lining
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Resistant to thermal spalling and severe structural stresses
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Hanger Bricks </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Hanger Bricks Quote</h3>
        <div class="row">
