...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h2 class="page-banner-title">Thermal Insulation Materials</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/insulation/ThermalInsulationMaterials.webp"
          alt="Thermal Insulation Materials - Thermal Insulation" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Thermal Insulation Materials</h3>
        <p class="lead">Thermal Insulation Materials encompass our broader range of energy-saving solutions tailored for
          industrial processes spanning low to ultra-high temperatures.</p>
        <p>This includes standard mineral wools (rockwool and glasswool) for piping and low-temperature ducting, up to
          state-of-the-art microporous insulation boards that offer thermal conductivities lower than still air. By
          selecting the optimal combination of our insulating materials, industrial plants can achieve maximum thermal
          efficiency and drastically reduce their carbon footprint.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Comprehensive portfolio catering from low to ultra-high temperatures
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Includes advanced microporous insulation for extreme space constraints
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Dramatically reduces energy consumption and carbon footprint
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Tailored solutions for piping, ductwork, ladles, and complex furnaces
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Thermal Insulation Materials </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Thermal Insulation Materials Quote</h3>
        <div class="row">
