  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>PRE-CAST SHAPES &amp; REFRACTORY
        BRICKS</span>
      <h2 class="page-banner-title">Isostatically Pressed Products</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/precast_shape/IsostaticallyPressedProducts.webp"
          alt="Isostatically Pressed Products - Pre-Cast Shapes and Bricks" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Isostatically Pressed Products</h3>
        <p class="lead">Isostatically Pressed Products represent the highest tier of refractory shaping technology. By
          applying uniform hydraulic pressure from all directions, we produce refractories with perfectly uniform
          density and zero internal flaws.</p>
        <p>This advanced manufacturing technique is primarily used to produce critical flow-control components like
          Submerged Entry Nozzles (SEN), Ladle Shrouds, and Monoblock Stoppers. The resulting products offer absolute
          reliability, exhibiting extraordinary resistance to thermal shock and high-velocity steel erosion.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Perfectly uniform density eliminates internal flaws and laminations
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Extraordinary resistance to severe thermal shock and steel erosion
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Guarantees reliable performance in continuous casting applications
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Used for critical components: SENs, Ladle Shrouds, and Stoppers
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Isostatically Pressed Products </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Isostatically Pressed Products Quote</h3>
        <div class="row">
