  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>PRE-CAST SHAPES &amp; REFRACTORY
        BRICKS</span>
      <h2 class="page-banner-title">Side Arch Bricks</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/precast_shape/SideArchBricks.webp"
          alt="Side Arch Bricks - Pre-Cast Shapes and Bricks" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Side Arch Bricks</h3>
        <p class="lead">Side Arch Bricks are specifically tapered along their length to allow for the construction of
          self-supporting refractory arches, furnace roofs (crowns), and cylindrical vessel linings.</p>
        <p>Available in various grades - including fireclay, high-alumina, and basic compositions - these shapes ensure
          tight, minimal mortar joints when turning an arch. The precise dimensional accuracy of our Side Arch Bricks
          guarantees even load distribution, preventing localized stress concentrations and extending the life of the
          arched structure.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Precision taper ensures tight joints in arch and cylindrical constructions
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Available in multiple refractory grades to suit different environments
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Facilitates even load distribution across the furnace crown
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Essential for the stable construction of rotary kilns and ladles
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Side Arch Bricks </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Side Arch Bricks Quote</h3>
        <div class="row">
