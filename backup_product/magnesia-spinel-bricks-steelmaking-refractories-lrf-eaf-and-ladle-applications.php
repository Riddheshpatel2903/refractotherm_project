...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h2 class="page-banner-title">Magnesia Spinel Bricks</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/steelmaking/MagnesiaSpinelBricks.webp"
          alt="Magnesia Spinel Bricks for Steelmaking and Ladle Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Magnesia Spinel Bricks</h3>
        <p class="lead">Magnesia Spinel Bricks are high-performance basic refractories composed of high-purity magnesia
          and synthetic alumina-magnesia spinel. They are widely used in the non-slag zones of steel ladles and
          transition zones of rotary kilns.</p>
        <p>The addition of pre-synthesized spinel to the magnesia matrix significantly improves the refractory
          flexibility, thereby providing outstanding resistance to thermal spalling and structural flaking. These bricks
          offer a chromium-free, environmentally friendly alternative with superior performance in environments
          subjected to severe thermal cycling.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Outstanding resistance to thermal shock and structural spalling
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Environmentally friendly, chromium-free refractory solution
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High refractoriness under load and excellent mechanical strength
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Superior resistance to basic slags and alkali attacks
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Magnesia Spinel Bricks </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Magnesia Spinel Bricks Quote</h3>
        <div class="row">
