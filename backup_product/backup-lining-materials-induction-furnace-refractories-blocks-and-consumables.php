...
<?php
$title = 'Backup Lining Materials Manufacturer & Supplier | Refractotherm';
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>INDUCTION FURNACE REFRACTORIES, BLOCKS &
        CONSUMABLES</span>
      <h2 class="page-banner-title">Backup Lining Materials</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/induction_furnace/BackupLiningMaterials.webp"
          alt="Backup Lining Materials for High Temperature Industrial Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Backup Lining Materials</h3>
        <p class="lead">Backup Lining Materials provide essential thermal insulation and mechanical support to the
          working lining in high-temperature industrial furnaces. These materials significantly reduce heat loss and
          improve the overall energy efficiency of the melting process.</p>
        <p>By maintaining an optimal temperature gradient across the furnace wall, backup linings help in reducing the
          thermal stress on the steel shell and induction coils. Our range includes insulating bricks, boards, and
          castables tailored for various furnace designs and operational demands.</p>
        <ul class="check overview-check-list">
          ...
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Reduces heat loss through the furnace walls
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Provides mechanical support to the primary lining
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Enhances the overall thermal efficiency of the furnace
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Backup Lining Materials </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Backup Lining Materials Quote</h3>
        <div class="row">
