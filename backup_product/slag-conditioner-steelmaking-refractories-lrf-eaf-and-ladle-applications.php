...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h2 class="page-banner-title">Slag Conditioner</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      ...
      <div class="split__body reveal">
        ...
        <h3>Slag Conditioner</h3>
        <p class="lead">Slag Conditioner is a highly reactive, synthetic metallurgical flux added to the steel ladle
          during secondary refining. It is designed to rapidly form a fluid, basic slag that facilitates the absorption
          of non-metallic inclusions and promotes efficient desulfurization.</p>
        <p>By modifying the physical and chemical properties of the ladle slag, our Slag Conditioner lowers the melting
          point and optimizes slag viscosity. Furthermore, it coats the refractory lining, creating a protective slag
          layer that significantly reduces chemical erosion of the magnesia-carbon bricks in the slag line.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Accelerates the formation of active, basic refining slag
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Promotes efficient desulfurization and inclusion removal
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Reduces chemical wear on expensive slag line refractories
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Improves overall steel cleanliness and quality
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Slag Conditioner </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Slag Conditioner Quote</h3>
        <div class="row">
