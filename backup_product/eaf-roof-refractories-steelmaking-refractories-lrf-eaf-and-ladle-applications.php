...
<?php
$title = 'Eaf Roof Refractories Manufacturer & Supplier | Refractotherm';
...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h2 class="page-banner-title">EAF Roof Refractories</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/steelmaking/EAFRoofRefractoriese.webp"
      ...
      <div class="split__body reveal">
        ...
        <h3>EAF Roof Refractories</h3>
        <p class="lead">Electric Arc Furnace (EAF) Roof Refractories consist of highly specialized bricks and monolithic
          castables designed to form the protective canopy over the melting zone. This area is subjected to extreme
          radiant heat, severe thermal shock, and chemical attack from rising fumes and slag splash.</p>
        <p>Depending on the furnace design, we provide high-alumina, mullite, or basic bricks for the outer roof rings,
          and ultra-high-strength, spall-resistant castables or precast blocks for the central delta section. Our
          solutions ensure maximum structural stability, preventing premature roof collapse and minimizing costly
          furnace downtime.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Exceptional resistance to intense radiant heat and thermal cycling
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High structural integrity prevents sagging and roof collapse
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Resistant to chemical attack from alkaline fumes and slag splash
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Custom-engineered shapes and castables for precise roof geometry
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for EAF Roof Refractories </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request EAF Roof Refractories Quote</h3>
        <div class="row">
