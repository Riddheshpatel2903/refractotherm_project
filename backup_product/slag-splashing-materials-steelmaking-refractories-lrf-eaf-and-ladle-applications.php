...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h2 class="page-banner-title">Slag Splashing Materials</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/steelmaking/SlagSplashingMaterials.webp"
          alt="Slag Splashing Materials for Steelmaking and Ladle Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Slag Splashing Materials</h3>
        <p class="lead">Slag Splashing Materials are specialized magnesia-based formulations utilized in the Basic
          Oxygen Furnace (BOF) to extend the refractory lining life. Following tapping, these materials are added to the
          residual slag, which is then splashed onto the furnace walls using high-pressure nitrogen.</p>
        <p>The addition of our Slag Splashing Materials conditions the residual slag, increasing its melting point and
          viscosity so that it adheres strongly to the worn areas of the working lining. This creates a highly
          refractory, protective frozen slag layer that shields the underlying bricks from subsequent heats, extending
          the BOF campaign life to thousands of heats.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Dramatically extends the campaign life of BOF linings
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High adhesion properties ensure a thick, protective slag coating
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Rapidly conditions residual slag for optimal splashing
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Reduces overall refractory consumption and maintenance downtime
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Slag Splashing Materials </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Slag Splashing Materials Quote</h3>
        <div class="row">
