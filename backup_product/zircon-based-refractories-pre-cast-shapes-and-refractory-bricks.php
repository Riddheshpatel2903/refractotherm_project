...
<?php
$title = 'Zircon Based Refractories Manufacturer & Supplier | Refractotherm';
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>PRE-CAST SHAPES &amp; REFRACTORY
        BRICKS</span>
      <h2 class="page-banner-title">Zircon Based Refractories</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/precast_shape/ZirconBasedRefractories.webp"
          alt="Zircon Based Refractories - Pre-Cast Shapes and Bricks" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Zircon Based Refractories</h3>
        <p class="lead">Zircon Based Refractories (Zirconium Silicate) are dense, highly inert materials favored for
          their exceptional resistance to aggressive chemical environments, particularly molten glass and continuous
          casting slags.</p>
        <p>These refractories exhibit very low thermal expansion, resulting in excellent thermal shock resistance. They
          are widely used as paving and sidewall blocks in glass melting tanks, and in the production of slide gate
          plates, nozzles, and crucibles for high-purity alloy melting.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Unparalleled resistance to corrosion by molten glass and specific slags
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Very low thermal expansion provides excellent thermal shock stability
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High density and low porosity prevent chemical infiltration
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Crucial for glass melting tanks and high-purity continuous casting
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Zircon Based Refractories </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Zircon Based Refractories Quote</h3>
        <div class="row">
