...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h2 class="page-banner-title">Ladle Insulation Materials</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/steelmaking/LadleInsulationMaterials.webp"
          alt="Ladle Insulation Materials for Steelmaking and Ladle Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Ladle Insulation Materials</h3>
        <p class="lead">Ladle Insulation Materials are critical components placed between the safety lining and the
          steel shell of the ladle. Their primary function is to minimize heat loss from the molten steel, thereby
          stabilizing casting temperatures and improving energy efficiency.</p>
        <p>By maintaining an optimal thermal gradient, these insulation materials - which include high-strength
          insulation boards, microporous panels, and insulating castables - reduce the thermal stress exerted on the
          ladle shell, preventing deformation. They are engineered to withstand high compressive loads while delivering
          exceptional insulating properties.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Significantly reduces heat loss and stabilizes molten steel temperature
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Protects the steel shell from thermal fatigue and deformation
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High compressive strength to withstand working lining expansion
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Improves overall energy efficiency of the steelmaking process
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Ladle Insulation Materials </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Ladle Insulation Materials Quote</h3>
        <div class="row">
