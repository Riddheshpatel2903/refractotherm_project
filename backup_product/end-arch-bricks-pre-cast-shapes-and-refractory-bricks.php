  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>PRE-CAST SHAPES &amp; REFRACTORY
        BRICKS</span>
      <h2 class="page-banner-title">End Arch Bricks</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      ...
      <div class="split__body reveal">
        ...
        <h3>End Arch Bricks</h3>
        <p class="lead">End Arch Bricks are tapered across their width rather than their length. They are utilized in
          conjunction with standard straights to turn arches of specific radii, particularly in narrower spans.</p>
        <p>These bricks are essential for constructing flues, small furnace doors, and intricate domed structures where
          a precise curvature is required. Like all our shaped refractories, they are manufactured with strict
          dimensional tolerances to ensure optimal structural integrity and minimal mortar usage.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Tapered width designed for constructing precise, tight-radius arches
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ideal for furnace doors, flues, and complex domed structures
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Strict dimensional tolerances ensure minimal mortar joint thickness
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Provides excellent structural stability in high-temperature zones
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for End Arch Bricks </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request End Arch Bricks Quote</h3>
        <div class="row">
