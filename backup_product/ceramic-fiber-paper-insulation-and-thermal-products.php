...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h2 class="page-banner-title">Ceramic Fiber Paper</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/insulation/CeramicFiberPaper.webp"
          alt="Ceramic Fiber Paper - Thermal Insulation" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Ceramic Fiber Paper</h3>
        <p class="lead">Ceramic Fiber Paper is a highly uniform, flexible sheet material manufactured from washed,
          high-purity ceramic fibers and a small amount of organic binder.</p>
        <p>It offers a highly resilient, low-thickness insulation solution that is easily die-cut into complex gaskets
          and seals. It is widely used to provide thermal barriers between induction furnace coils and the refractory
          crucible, as expansion joint fillers in brickwork, and as parting agents in high-temperature metal casting
          processes.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Highly uniform thickness and excellent flexibility for intricate wrapping
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Easily die-cut to create precise high-temperature gaskets and seals
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Provides a highly resilient thermal barrier in confined spaces
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ideal for induction furnace coil insulation and expansion joints
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Ceramic Fiber Paper </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Ceramic Fiber Paper Quote</h3>
        <div class="row">
