...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h2 class="page-banner-title">EBT Filler Sand</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/steelmaking/EBTFillerSand.webp"
          alt="EBT Filler Sand for Steelmaking and Ladle Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>EBT Filler Sand</h3>
        <p class="lead">EBT Filler Sand is a specialized granular refractory material used to fill the Eccentric Bottom
          Tapping (EBT) taphole in Electric Arc Furnaces. Its primary function is to prevent molten steel from freezing
          in the taphole while ensuring a safe, consistent, and automatic free-opening upon tapping.</p>
        <p>Typically composed of carefully graded olivine or magnesia-based minerals, our EBT Filler Sand features a
          precisely controlled sintering profile. The top layer sinters slightly to form a protective crust that
          withstands steel penetration and static pressure, while the bulk of the sand remains loose and flowable,
          guaranteeing a free-opening rate approaching 100%.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Guarantees exceptionally high free-opening rates (close to 100%)
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Prevents molten steel penetration and freezing in the taphole
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Controlled sintering profile creates a secure, protective crust
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Safe, flowable, and easy to apply between heats
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for EBT Filler Sand </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request EBT Filler Sand Quote</h3>
        <div class="row">
