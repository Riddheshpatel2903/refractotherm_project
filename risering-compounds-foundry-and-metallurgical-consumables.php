...
<?php
$title = "Risering Compounds Manufacturer & Supplier | Refractotherm";
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>FOUNDRY &amp; METALLURGICAL
        CONSUMABLES</span>
      <h2 class="page-banner-title">Risering Compounds</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/foundries/RiseringCompounds.webp"
          alt="Risering Compounds - Foundry &amp; Metallurgical Consumables" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Risering Compounds</h3>
        <p class="lead">Risering Compounds (also known as hot-topping or anti-piping compounds) are applied to the top
          surface of the open riser immediately after pouring.</p>
        <p>These specialized powders rapidly expand upon heating to form a highly insulating, porous crust over the
          liquid metal. By preventing radiant heat loss to the atmosphere, they ensure the metal in the riser remains
          liquid and available to feed the casting as it solidifies and shrinks, thus eliminating deep piping defects.
        </p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Forms a highly insulating crust over the open riser surface
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Prevents radiant heat loss and premature freezing of the feeder metal
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Eliminates deep piping defects and shrinkage in the casting
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Easy to apply and highly consistent in expansion and insulation
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Risering Compounds </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Risering Compounds Quote</h3>
        <div class="row">
