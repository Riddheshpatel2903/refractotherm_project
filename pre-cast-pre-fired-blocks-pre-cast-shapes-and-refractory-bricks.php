  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>PRE-CAST SHAPES &amp; REFRACTORY
        BRICKS</span>
      <h2 class="page-banner-title">Pre-Cast Pre-Fired Blocks</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/precast_shape/pre-castpre-firedblocks.webp"
          alt="Pre-Cast Pre-Fired Blocks - Pre-Cast Shapes and Bricks" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Pre-Cast Pre-Fired Blocks</h3>
        <p class="lead">Pre-Cast Pre-Fired (PCPF) Blocks represent the pinnacle of modern refractory engineering. They
          are manufactured under strictly controlled factory conditions, eliminating the variables and risks associated
          with on-site casting.</p>
        <p>Using advanced ultra-low cement castables, these blocks are cast into complex geometries, carefully dried,
          and prefired to high temperatures before dispatch. This rigorous process guarantees maximum density, zero
          residual moisture, and exceptional resistance to thermal spalling and mechanical impact, making them ideal for
          rapid furnace turnarounds.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Zero on-site mixing, casting, or curing time required
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Manufactured under strictly controlled conditions for optimal density
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Prefired to eliminate residual moisture and prevent explosive spalling
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Custom-designed complex geometries to fit any furnace profile
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Pre-Cast Pre-Fired Blocks </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Pre-Cast Pre-Fired Blocks Quote</h3>
        <div class="row">
