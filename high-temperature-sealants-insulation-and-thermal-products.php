...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">High Temperature Sealants</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">High Temperature Sealants Details</li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/insulation/HighTemperatureSealants.webp"
          alt="High Temperature Sealants - Thermal Insulation" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>High Temperature Sealants</h3>
        <p class="lead">High Temperature Sealants and mastics are specialized, air-setting refractory pastes used for
          critical bonding, patching, and sealing applications in extreme thermal environments.</p>
        <p>These ready-to-use compounds adhere strongly to metals, ceramics, and brickwork. They cure quickly at room
          temperature to form a hard, gas-tight seal that is highly resistant to thermal shock, flame impingement, and
          corrosive fumes. They are widely used for sealing boiler doors, repairing cracked brickwork, and bonding
          ceramic fiber modules.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Forms a hard, gas-tight seal resistant to extreme temperatures
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Strong adhesion to a wide variety of substrates (metal, ceramic, brick)
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ready-to-use paste formulation for easy, immediate application
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ideal for sealing boiler doors, flues, and repairing cracked masonry
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for High Temperature Sealants </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request High Temperature Sealants Quote</h3>
        <div class="row">
