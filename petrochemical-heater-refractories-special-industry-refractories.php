...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Petrochemical Heater Refractories</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Petrochemical Heater Refractories Details</li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/spacial_industries/PetrochemicalHeaterRefractories.webp"
          alt="Petrochemical Heater Refractories - Refractotherm" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Petrochemical Heater Refractories</h3>
        <p class="lead">Petrochemical Heater Refractories are utilized in the construction and repair of fired heaters,
          reformers, and cracking units within oil refineries and chemical plants.</p>
        <p>These applications prioritize maximum thermal efficiency and resistance to corrosive atmospheres (such as
          sulfur or hydrogen). We supply a comprehensive package of lightweight insulating castables, ceramic fiber
          modules, and specialized acid-resistant linings. These products minimize heat loss, protect the steel casing
          from chemical attack, and ensure the safe, efficient operation of the plant.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Lightweight insulating castables maximize heater thermal efficiency
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Specialized acid-resistant linings protect against sulfur and corrosive gases
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High-purity formulations resist hydrogen attack in reformer units
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Comprehensive solutions including monolithic linings and ceramic fibers
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Petrochemical Heater Refractories </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Petrochemical Heater Refractories Quote</h3>
        <div class="row">
