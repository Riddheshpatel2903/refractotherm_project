...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>FOUNDRY &amp; METALLURGICAL
        CONSUMABLES</span>
      <h1 class="page-banner-title">Synthetic Slag</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Synthetic Slag Details</li>
    </ol>
  </nav>
    ...
    <div class="container split">
      ...
      <div class="split__body reveal">
        ...
        <p>Carefully formulated with optimum basicity (typically high in CaO and Al2O3), our synthetic slag melts
          rapidly to form a highly fluid, reactive layer on top of the molten bath. This active slag layer aggressively
          absorbs non-metallic inclusions and promotes deep desulfurization, resulting in exceptionally clean,
          high-quality steel or iron.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Melts rapidly to form a highly fluid and reactive slag layer
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Aggressively absorbs non-metallic inclusions for cleaner metal
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Promotes deep and efficient desulfurization in the ladle
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Protects the molten bath from atmospheric oxidation
          </li>
        </ul>
      </div>
    </div>
