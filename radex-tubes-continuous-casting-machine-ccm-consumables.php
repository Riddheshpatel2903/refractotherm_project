...
<body>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Radex Tubes </li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/ccm/RadexPowder.webp" alt="Radex Tubes for Molten Steel Stream Protection and Continuous Casting Applications" />
