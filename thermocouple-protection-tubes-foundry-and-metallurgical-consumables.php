...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>FOUNDRY &amp; METALLURGICAL
        CONSUMABLES</span>
      <h1 class="page-banner-title">Thermocouple Protection Tubes</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Thermocouple Protection Tubes Details</li>
    </ol>
  </nav>
    ...
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/foundries/ThermocoupleProtectionTubes.webp"
          alt="Thermocouple Protection Tubes - Foundry &amp; Metallurgical Consumables" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Thermocouple Protection Tubes</h3>
        <p class="lead">Thermocouple Protection Tubes are robust, highly refractory sheaths designed to protect delicate
          thermocouple wires from the extreme heat and corrosive attack of molten metal and slag.</p>
        <p>Manufactured from advanced materials such as Silicon Carbide, Silicon Nitride, or high-density Alumina, these
          tubes exhibit outstanding thermal conductivity. This ensures rapid and accurate temperature readings while
          providing a completely impermeable barrier against metal penetration and chemical corrosion, extending the
          life of the sensor.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Provides an impermeable barrier against molten metal and slag
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High thermal conductivity ensures rapid and accurate temperature readings
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Exceptional resistance to thermal shock during immersion
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Extends the lifespan of expensive thermocouple sensors
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Thermocouple Protection Tubes </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Thermocouple Protection Tubes Quote</h3>
        <div class="row">
