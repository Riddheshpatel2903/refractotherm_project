  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>CONTINUOUS CASTING MACHINE (CCM)
        CONSUMABLES</span>
      <h2 class="page-banner-title">Tundish Covering Compounds</h2>
    </div>
  </section>
        ...
        <div class="careers-timeline-item reveal">
          <div class="careers-timeline-body">
            ...
            <p class="careers-timeline-desc">
              Maintains thermal stability and protects molten steel during billet production.
            </p>
          </div>
        </div>
        <div class="careers-timeline-item reveal">
          <div class="careers-timeline-body">
            ...
            <p class="careers-timeline-desc">
              Provides insulation and oxidation protection throughout casting campaigns.
            </p>
          </div>
        </div>
        <div class="careers-timeline-item reveal">
          <div class="careers-timeline-body">
            ...
            <p class="careers-timeline-desc">
              Supports long casting sequences by reducing temperature losses.
            </p>
          </div>
        </div>
        <div class="careers-timeline-item reveal">
          <div class="careers-timeline-body">
            ...
            <p class="careers-timeline-desc">
              Suitable for high-quality steel grades requiring enhanced cleanliness and process control. </p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Tundish Covering Compounds</h3>
        <p>Speak with our continuous casting and steelmaking specialists to select the most suitable Tundish Covering
          Compound for your casting process, steel grades, tundish design, and operating conditions. Customized
          formulations are available to meet specific production requirements.</p>
        <ul class="cta__info">
      ...
      <form class="cta__form"
        ...
        <h3>Request Tundish Covering Compounds Quote</h3>
        <div class="row">
