...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Repair Mixes</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Repair Mixes </li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/aod/RepairMixes.webp" alt="Repair Mixes - AOD Refractories Argon Oxygen Decarburization - Refractotherm" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h2>Repair Mixes</h2>
        <p class="lead">Repair Mixes are highly plastic, hand-applied or trowelable refractory formulations used for
          precision cold repairs of the AOD converter. They are particularly critical for rebuilding worn areas around
          the tuyere pad and filling deep joints or gouges in the lining.</p>
        <p>Manufactured from finely graded magnesia and specialized binders, these mixes offer excellent workability and
          high adhesive strength. Upon heating, they cure into a rock-hard monolithic mass that perfectly matches the
          thermal expansion profile of the surrounding bricks, preventing shrinkage cracks and ensuring a gas-tight
          seal.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Highly plastic and workable for precision troweling and patching
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Perfect for rebuilding critical wear zones around AOD tuyeres
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Matches the thermal expansion of surrounding bricks to prevent cracking
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Cures to a high-strength, gas-tight monolithic mass
          </li>
        </ul>
      </div>
    </div>
