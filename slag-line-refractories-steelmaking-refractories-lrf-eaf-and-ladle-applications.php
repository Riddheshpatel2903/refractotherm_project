    ...
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/aod/SlagLineRefractories.webp"
          alt="Slag Line Refractories for Steelmaking and Ladle Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Slag Line Refractories</h3>
        <p class="lead">Slag Line Refractories are specialized high-grade materials specifically designed to endure the
          most aggressive environment in steel ladles and furnaces - the slag-metal interface. This zone experiences
          intense chemical corrosion, oxidation, and mechanical erosion.</p>
        <p>Our slag line solutions typically utilize ultra-high-grade Magnesia Carbon bricks with optimized graphite
          content and advanced antioxidant systems. These refractories create a dense, highly resistant barrier that
          minimizes wear rates, significantly extending the overall campaign life of the ladle and ensuring safe,
          reliable steelmaking operations.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Exceptional resistance to highly aggressive, corrosive basic slags
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Advanced antioxidant systems to prevent carbon oxidation
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High density and low porosity to resist slag penetration
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Tailored formulations for varying slag basicity and temperatures
          </li>
        </ul>
      </div>
    </div>
