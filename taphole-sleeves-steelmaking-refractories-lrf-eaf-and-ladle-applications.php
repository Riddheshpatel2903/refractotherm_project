...
<?php
$title = "Taphole Sleeves Manufacturer & Supplier | Refractotherm";
...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h2 class="page-banner-title">Taphole Sleeves</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/steelmaking/TapholeSleeves.jpg"
      ...
      <div class="split__body reveal">
        ...
        <h3>Taphole Sleeves</h3>
        <p class="lead">Taphole Sleeves are precision-engineered refractory tubes installed in Basic Oxygen Furnaces
          (BOF) and Electric Arc Furnaces (EAF) to facilitate the controlled tapping of molten steel into the ladle.
          They play a vital role in maintaining steel quality and minimizing slag carryover.</p>
        <p>Subjected to extreme thermal shock, high-velocity metal flow, and chemical erosion, our Taphole Sleeves are
          manufactured from premium-grade magnesia-carbon or high-alumina materials. They are designed to maintain a
          consistent internal diameter throughout their lifespan, ensuring a tight, focused tapping stream and reducing
          tap times.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Maintains a focused tapping stream to minimize oxygen pickup
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High resistance to erosion from high-velocity molten steel
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Excellent thermal shock resistance during tapping cycles
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Extends taphole life and reduces the frequency of replacements
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Taphole Sleeves </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Taphole Sleeves Quote</h3>
        <div class="row">
