  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>FOUNDRY &amp; METALLURGICAL
        CONSUMABLES</span>
      <h2 class="page-banner-title">Filter Sleeves</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/foundries/FilterSleeves.jpg"
      ...
      <div class="split__body reveal">
        ...
        <h3>Filter Sleeves</h3>
        <p class="lead">Filter Sleeves combine the insulating properties of a refractory sleeve with the purifying
          capabilities of a ceramic foam or extruded filter, placed directly in the gating system.</p>
        <p>These innovative components ensure that only clean, inclusion-free molten metal enters the mold cavity. By
          trapping slag, dross, and non-metallic impurities, while simultaneously smoothing the flow (converting
          turbulent flow to laminar flow), our Filter Sleeves drastically reduce casting rejection rates and improve the
          mechanical properties of the finished part.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Effectively traps slag, dross, and non-metallic inclusions
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Converts turbulent metal flow into smooth, laminar flow
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Drastically reduces casting defects and subsequent rework
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Improves the machinability and mechanical integrity of the casting
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Filter Sleeves </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Filter Sleeves Quote</h3>
        <div class="row">
