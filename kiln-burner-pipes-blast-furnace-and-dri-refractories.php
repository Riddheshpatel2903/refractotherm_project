...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Kiln Burner Pipes</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Kiln Burner Pipes </li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/blast_furnace/kilnburnerpipes.webp"
          alt="Kiln Burner Pipes for Blast Furnace and DRI Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Kiln Burner Pipes</h3>
        <p class="lead">Kiln Burner Pipes (or burner lances) project into the rotary kiln to deliver pulverized coal,
          oil, or gas. They are constantly exposed to the most intense radiant heat and abrasive dust within the kiln
          environment.</p>
        <p>We supply advanced, pre-cast refractory coatings for burner pipes using ultra-low cement, high-alumina
          castables heavily reinforced with stainless steel fibers. This protective jacket prevents the metallic lance
          from warping or melting, ensuring precise flame positioning and uninterrupted kiln combustion.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Protects the metallic burner lance from melting and thermal warping
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Heavily reinforced with steel fibers to prevent cracking and spalling
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Withstands intense radiant heat and abrasive kiln dust
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ensures precise flame geometry for optimal kiln thermal profiles
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Kiln Burner Pipes </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Kiln Burner Pipes Quote</h3>
        <div class="row">
