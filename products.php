  ...
  <section class="section">
    <div class="container">
      ...
      <p class="section-intro-text">
        We offer a comprehensive range of refractory products, metallurgical consumables, flow control systems, insulation materials, and technical services designed to meet the demanding requirements of the steel, foundry, ferro alloy, and process industries.
      </p>
    </div>
  </section>
