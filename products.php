...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <p class="lead page-banner-lead">Comprehensive thermal solutions designed to withstand extreme operating
        conditions, extending campaign life and optimizing energy efficiency.</p>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      <div class="section__head section__head--center">
        <div>
          <span class="eyebrow"><span class="eyebrow__bar"></span>Performance Defined</span>
          <h3>Advanced materials for critical applications.</h3>
        </div>
      </div>
      <p class="section-intro-text">
        From primary steelmaking to secondary refining, continuous casting, and non-ferrous applications, REFRACTOTHERM
        offers a complete portfolio of over 500 specialized refractory products. Our formulations are continuously
        optimized using predictive thermal modeling and rigorous post-mortem analysis of spent linings.
      </p>
    </div>
  </section>
