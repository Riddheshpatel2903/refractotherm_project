      ...
      <div class="testimonials-marquee-wrapper">
        <div class="testimonials-marquee-track">
          ...
          <div class="testimonial-item">
            ...
            <h4 class="testimonial-author">- Operations Manager</h4>
          </div>
          ...
          <div class="testimonial-item">
            ...
            <h4 class="testimonial-author">- Technical Director</h4>
          </div>
          ...
          <div class="testimonial-item">
            ...
            <h4 class="testimonial-author">- Blast Furnace Superintendent</h4>
          </div>
