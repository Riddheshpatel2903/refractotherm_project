...
<?php
$title = 'Coke Oven Refractories Manufacturer & Supplier | Refractotherm';
...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Coke Oven Refractories</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Coke Oven Refractories </li>
    </ol>
  </nav>
    ...
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/blast_furnace/CokeOvenRefractories.webp"
          alt="Coke Oven Refractories for Blast Furnace and DRI Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Coke Oven Refractories</h3>
        <p class="lead">Coke Oven Refractories form the structural backbone of the coke battery, subjected to extreme
          thermal cycling, heavy mechanical loads from the pushing ram, and chemical attack from coal gases.</p>
        <p>We supply ultra-high density Silica Bricks for the oven walls, which offer phenomenal load-bearing capacity
          at high temperatures and precise thermal expansion characteristics. For coke oven doors and jambs, we provide
          high-strength, thermal shock-resistant castables and pre-cast blocks that minimize gas leakage and
          maintenance.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Ultra-dense Silica Bricks with exceptional load-bearing capacity
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Precise thermal expansion properties for stable battery operation
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High-strength door castables minimize gas leakage and heat loss
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Resistant to abrasion from the coke pushing operation
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Coke Oven Refractories </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Coke Oven Refractories Quote</h3>
        <div class="row">
