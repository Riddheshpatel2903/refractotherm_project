...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>SPECIAL STEEL &amp; VACUUM
        REFRACTORIES</span>
      <h1 class="page-banner-title">Special Steel Tundish Refractories</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Special Steel Tundish Refractories Details</li>
    </ol>
  </nav>
    ...
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/spacial_steel/SpecialSteelTundishRefractories.webp"
          alt="Special Steel Tundish Refractories - Refractotherm" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Special Steel Tundish Refractories</h3>
        <p class="lead">Special Steel Tundish Refractories are formulated specifically for the continuous casting of
          high-alloy, stainless, and bearing steels, where even microscopic non-metallic inclusions cause rejection.</p>
        <p>We provide highly basic (magnesia-based) dry vibratable mixes and spray coatings for the tundish working
          lining. These linings actively absorb inclusions from the steel rather than contributing to them. Coupled with
          our high-purity alumina impact pads and flow-control dams, they ensure a smooth, laminar flow of immaculately
          clean steel into the mold.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Highly basic formulations actively absorb non-metallic inclusions
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Zero silica pickup ensures absolute purity of special steel grades
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Dry vibratable options allow for rapid installation and long sequences
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Promotes laminar flow and optimal inclusion flotation in the tundish
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Special Steel Tundish Refractories </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Special Steel Tundish Refractories Quote</h3>
        <div class="row">
