...
<?php
$title = 'Blast Furnace Trough Castables Manufacturer & Supplier | Refractotherm';
...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Blast Furnace Trough Castables</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Blast Furnace Trough Castables </li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/blast_furnace/BlastFurnaceTroughCastables.webp"
          alt="Blast Furnace Trough Castables for Blast Furnace and DRI Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Blast Furnace Trough Castables</h3>
        <p class="lead">Blast Furnace Trough Castables are highly specialized, ultra-low cement formulations (typically
          Alumina-Silicon Carbide-Carbon based) engineered for the main iron runner of the blast furnace casthouse.</p>
        <p>These castables are subjected to continuous flows of extremely hot molten iron (hot metal) and corrosive
          blast furnace slag. Our formulations provide phenomenal hot-strength, outstanding oxidation resistance, and
          superior resistance to mechanical scouring, dramatically extending the campaign life of the main trough.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Exceptional resistance to continuous high-velocity flow of molten iron
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Outstanding chemical resistance against corrosive blast furnace slag
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Advanced antioxidant systems prevent carbon burnout in the trough
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Maximizes campaign life and reduces casthouse downtime
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Blast Furnace Trough Castables </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Blast Furnace Trough Castables Quote</h3>
        <div class="row">
