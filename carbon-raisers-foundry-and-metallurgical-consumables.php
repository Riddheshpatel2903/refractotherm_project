...
<?php
$title = 'Carbon Raisers Manufacturer & Supplier | Refractotherm';
...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>FOUNDRY &amp; METALLURGICAL
        CONSUMABLES</span>
      <h1 class="page-banner-title">Carbon Raisers</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Carbon Raisers Details</li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/foundries/CarbonRaisers.webp"
          alt="Carbon Raisers - Foundry &amp; Metallurgical Consumables" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Carbon Raisers</h3>
        <p class="lead">Carbon Raisers (or recarburizers) are high-purity carbonaceous materials added to the melting
          furnace or ladle to precisely adjust and increase the carbon content of the liquid metal.</p>
        <p>Our portfolio includes Calcined Petroleum Coke (CPC) and synthetic graphite granules characterized by
          exceptionally high fixed carbon, low sulfur, and low ash content. They offer rapid dissolution rates and
          highly predictable carbon recovery, allowing foundries and steel plants to achieve exact metallurgical
          specifications efficiently.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Exceptionally high fixed carbon content with low sulfur and ash
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Rapid dissolution and highly predictable carbon recovery rates
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Allows for precise metallurgical control of iron and steel grades
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Available in tailored grain sizes to minimize dust and oxidation loss
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Carbon Raisers </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Carbon Raisers Quote</h3>
        <div class="row">
