...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h2 class="page-banner-title">Taphole Refractories</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/aod/TapholeRefractories.jpg"
          alt="Taphole Refractories for AOD and Secondary Metallurgy" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Taphole Refractories</h3>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Taphole Refractories </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Taphole Refractories Quote</h3>
        <div class="row">
