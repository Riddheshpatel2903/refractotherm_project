...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Taphole Refractories</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Taphole Refractories </li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      ...
      <div class="split__body reveal">
        ...
        <h2>Taphole Refractories</h2>
        <p class="lead">Taphole Refractories for AOD converters consist of specialized pre-cast blocks and high-density
          tubes designed to facilitate the safe and rapid tapping of the refined stainless steel. The taphole area is
          subjected to extreme thermal shock and high-velocity erosion.</p>
        <p>We utilize premium Magnesia-Carbon or dense Alumina-Chrome composites to manufacture taphole assemblies that
          maintain their precise internal diameter over multiple heats. This ensures a tight, cohesive tapping stream,
          which is critical for minimizing atmospheric oxygen pickup and reducing slag carryover into the teeming ladle.
        </p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Maintains a tight, cohesive tapping stream to minimize oxygen pickup
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Outstanding resistance to high-velocity molten steel erosion
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Reduces tap times and minimizes unwanted slag carryover
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Available as single-piece tubes or multi-component block assemblies
          </li>
        </ul>
      </div>
    </div>
