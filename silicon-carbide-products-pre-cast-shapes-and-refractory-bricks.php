  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>PRE-CAST SHAPES &amp; REFRACTORY
        BRICKS</span>
      <h2 class="page-banner-title">Silicon Carbide Products</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/precast_shape/SiliconCarbideProducts.jpg"
          alt="Silicon Carbide Products - Pre-Cast Shapes and Bricks" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Silicon Carbide Products</h3>
        <p class="lead">Silicon Carbide (SiC) Products are advanced refractories utilized in the most extreme abrasive
          and thermal environments. SiC boasts a hardness second only to diamond and thermal conductivity comparable to
          metals.</p>
        <p>Available as nitride-bonded, oxide-bonded, or recrystallized SiC, these products are virtually immune to
          thermal shock and highly resistant to acidic and basic slags. They are extensively used as muffle furnace
          plates, zinc distillation retorts, incinerator linings, and wear-resistant tiles in mineral processing.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Extreme hardness provides unmatched resistance to mechanical abrasion
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Exceptionally high thermal conductivity ensures rapid heat transfer
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Virtually immune to thermal shock and extreme temperature gradients
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Highly resistant to chemical attack from aggressive slags and gases
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Silicon Carbide Products </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Silicon Carbide Products Quote</h3>
        <div class="row">
