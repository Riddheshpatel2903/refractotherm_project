...
<?php
$title = "Ceramic Fiber Board Manufacturer & Supplier | Refractotherm";
...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h2 class="page-banner-title">Ceramic Fiber Board</h2>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/insulation/CeramicFiberBoard.avif"
          alt="Ceramic Fiber Board - Thermal Insulation" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Ceramic Fiber Board</h3>
        <p class="lead">Ceramic Fiber Boards are rigid, vacuum-formed insulation products manufactured from ceramic
          fiber blended with specialized organic and inorganic binders.</p>
        <p>Designed for applications requiring high structural rigidity and exceptional insulating properties, these
          boards can easily be machined, cut, and shaped. They exhibit high hot-compressive strength and resist abrasion
          from high-velocity hot gases. They are extensively used as backup insulation in ladles and tundishes, and as
          hot-face linings in low-velocity industrial ovens.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High structural rigidity and excellent compressive strength
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Easily machined and die-cut to precise dimensional tolerances
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Resistant to abrasion and erosion from high-velocity hot gases
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Provides superior backup insulation behind dense castables and bricks
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Ceramic Fiber Board </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Ceramic Fiber Board Quote</h3>
        <div class="row">
