...
<body>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Furnace Lining Materials Details</li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/induction_furnace/FurnaceLiningMaterials.webp"
          alt="Furnace Lining Materials for High Temperature Industrial Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Furnace Lining Materials</h3>
        <p class="lead">Furnace Lining Materials encompass a comprehensive range of refractory solutions, including
          ramming masses, castables, and bricks, designed to form the primary working lining of induction furnaces.</p>
        <p>The working lining is the heart of the furnace, subjected to severe thermal cycling, mechanical impact, and
          chemical erosion. Our carefully engineered lining materials provide superior volume stability, optimal
          sintering characteristics, and extended campaign life, ensuring uninterrupted and efficient metal production.
        </p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Optimized for specific metal grades and operating temperatures
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Excellent resistance to metal and slag penetration
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Consistent and predictable sintering behavior
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Maximizes furnace availability and productivity
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Furnace Lining Materials </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Furnace Lining Materials Quote</h3>
        <div class="row">
