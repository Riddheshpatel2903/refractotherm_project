...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Tap Hole Clay</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Tap Hole Clay </li>
    </ol>
  </nav>
    ...
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/blast_furnace/TapHoleClay.webp"
          alt="Tap Hole Clay for Blast Furnace and DRI Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Tap Hole Clay</h3>
        <p class="lead">Tap Hole Clay is a highly plastic, resin or tar-bonded unshaped refractory used to seal the
          blast furnace taphole against the immense pressure of the hearth.</p>
        <p>Our Tap Hole Clay is precisely formulated to remain workable in the mud gun, yet cure rapidly upon injection
          into the hot taphole. It forms a dense, robust plug that prevents premature breakouts, while maintaining
          excellent drillability to ensure a smooth, stable, and controlled hot metal stream during the next cast.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Cures rapidly to form a secure, high-strength plug under pressure
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Excellent drillability ensures smooth and controlled taphole opening
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Protects the hearth refractories around the taphole channel
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Environmentally friendly, low-emission resin-bonded options available
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Tap Hole Clay </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Tap Hole Clay Quote</h3>
        <div class="row">
