...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      <span class="eyebrow eyebrow--light"><span class="eyebrow__bar"></span>PRE-CAST SHAPES &amp; REFRACTORY
        BRICKS</span>
      <h1 class="page-banner-title">High Alumina Bricks</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">High Alumina Bricks Details</li>
    </ol>
  </nav>
    ...
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/precast_shape/HighAluminaBricks.webp"
          alt="High Alumina Bricks - Pre-Cast Shapes and Bricks" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>High Alumina Bricks</h3>
        <p class="lead">High Alumina Bricks are the workhorse of industrial refractories, widely used across the steel,
          cement, glass, and petrochemical industries. We offer a comprehensive range containing from 45% up to 90%
          Al2O3.</p>
        <p>Formulated from premium bauxite, sillimanite, and tabular alumina, these bricks deliver superior
          refractoriness under load, excellent volume stability, and strong resistance to both acidic and basic slags.
          They are ideal for use in the working linings of rotary kilns, electric arc furnace roofs, ladles, and glass
          tank regenerators.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Wide range of alumina contents (45% - 90%) for diverse applications
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Superior refractoriness under load and high-temperature stability
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Excellent resistance to structural spalling and slag attack
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High mechanical strength across a broad temperature range
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for High Alumina Bricks </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request High Alumina Bricks Quote</h3>
        <div class="row">
