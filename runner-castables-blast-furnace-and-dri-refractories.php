...
<body>
  ...
  <section class="section section--dark page-banner-section">
    ...
    <div class="container page-banner-container">
      ...
      <h1 class="page-banner-title">Runner Castables</h1>
    </div>
  </section>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Runner Castables </li>
    </ol>
  </nav>
  ...
  <section class="section">
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/blast_furnace/RunnerCastables.webp"
          alt="Runner Castables for Blast Furnace and DRI Applications" />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h3>Runner Castables</h3>
        <p class="lead">Runner Castables are utilized to line the network of iron and slag runners that distribute hot
          metal and slag from the main trough to the torpedo ladles and slag pits.</p>
        <p>Formulated with high-grade bauxite, brown fused alumina, and silicon carbide, these castables exhibit
          excellent flow characteristics for easy installation. They form a dense, smooth surface that minimizes metal
          adhesion and provides long-lasting resistance to thermal shock and abrasive wear during casting.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Smooth, dense surface minimizes iron and slag adhesion
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            High abrasion resistance against flowing hot metal
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Excellent flowability allows for rapid pump or vibration casting
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Cost-effective solutions for secondary casthouse runners
          </li>
        </ul>
      </div>
    </div>
  ...
  <!-- <section class="cta" id="contact">
    ...
    <div class="container cta__grid">
      <div class="cta__intro">
        ...
        <h3>Request a Quote for Runner Castables </h3>
      ...
      <form class="cta__form"
        ...
        <h3>Request Runner Castables Quote</h3>
        <div class="row">
