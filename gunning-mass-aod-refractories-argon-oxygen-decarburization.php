...
<body>
  ...
  <nav class="breadcrumb-nav" aria-label="Breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="active">Gunning Mass </li>
    </ol>
  </nav>
    ...
    <div class="container split">
      <div class="split__media reveal">
        <img src="assets/images/resources/products/aod/gunningmass.webp"
          alt="Gunning Mass - AOD Refractories Argon Oxygen Decarburization - Refractotherm " />

      </div>
      <div class="split__body reveal">
        <span class="eyebrow"><span class="eyebrow__bar"></span>Product Overview</span>
        <h2>Gunning Mass</h2>
        <p class="lead">Gunning Mass is an essential unshaped refractory used to perform rapid hot-repairs on the AOD
          working lining. It allows operators to patch deeply worn areas - such as the trunnions and slag line - without
          cooling down the vessel, thereby maximizing equipment availability.</p>
        <p>Our Magnesia-based gunning mixes feature advanced chemical binders that ensure rapid sintering upon contact
          with the hot furnace wall. They exhibit remarkably low rebound rates and form a dense, highly adhesive patch
          that seamlessly integrates with the existing brickwork to withstand subsequent blowing cycles.</p>
        <ul class="check overview-check-list">
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Enables rapid hot-repairs to maximize AOD converter availability
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Remarkably low rebound rates for cost-effective application
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Forms a dense, highly adhesive patch that resists slag erosion
          </li>
          <li class="overview-check-item">
            <i class="fa-solid fa-check overview-check-icon"></i>
            Seamlessly integrates with the existing Magnesia-Chrome or Dolomite lining
          </li>
        </ul>
      </div>
    </div>
